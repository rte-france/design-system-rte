...
const Pagination = ({
  ...
  const isPreviousButtonDisabled = isFirstPage() ? "true" : undefined;
  const isNextButtonDisabled = isLastPage() ? "true" : undefined;
    ...
    <nav className={styles["rte-pagination"]} data-testid="pagination" data-appearance={appearance}>
      {hasGoToFirst && (
        <button
          ...
          data-disabled={isPreviousButtonDisabled}
      ...
      {hasGoToNext && (
        <button
          ...
          data-disabled={isNextButtonDisabled}
