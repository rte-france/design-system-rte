...
} from "@design-system-rte/core/components/popover/popover.interface";
import {
  POPOVER_GAP,
  POPOVER_GAP_ARROW
} from "@design-system-rte/core/components/popover/popover.constants";
...
const Popover = forwardRef<HTMLDivElement, PopoverProps>(({
  ...
  const handleTriggerInteraction = (e: React.MouseEvent | React.KeyboardEvent) => {
    if (!isOpen && ((e.type === 'click' && (e as React.MouseEvent).button === 0) ||
    (e.type === 'keydown' && ((e as React.KeyboardEvent).key === 'Enter' || (e as React.KeyboardEvent).key === ' ')))) {
      setIsOpen(true);
    }
  };
