...
import {
  ...
  CheckboxOutlined,
  CircuitAmperemetreFilled,
  CircuitAmperemetreOutlined,
  CircuitBulbFilled,
  CircuitBulbOutlined,
  CircuitCapacitor,
  CircuitCell,
  CircuitGeneratorFilled,
  CircuitGeneratorOutlined,
  CircuitGround,
  CircuitInductor,
  CircuitMotorFilled,
  CircuitMotorOutlined,
  CircuitVoltmetreFilled,
  CircuitVoltmetreOutlined,
  ClockFilled,
  ClockOutlined,
  Close,
  CloudDownloadFilled,
  ...
  Link,
  LinkOff,
  LinkedServicesFilled,
  LinkedServicesOutlined,
  List,
  ListAltFilled,
  ListAltOutlined,
  LocationAddFilled,
...
export const RegularIcons = {
  ...
  "circuit-capacitor": CircuitCapacitor,
  "circuit-cell": CircuitCell,
  "circuit-ground": CircuitGround,
  "circuit-inductor": CircuitInductor,
  close: Close,
  company: Company,
  compare: Compare,
  "copy-all": CopyAll,
...
export const TogglableIcons = {
  ...
  "circuit-amperemetre": [CircuitAmperemetreOutlined, CircuitAmperemetreFilled],
  "circuit-bulb": [CircuitBulbOutlined, CircuitBulbFilled],
  "circuit-generator": [CircuitGeneratorOutlined, CircuitGeneratorFilled],
  "circuit-motor": [CircuitMotorOutlined, CircuitMotorFilled],
  "circuit-voltmetre": [CircuitVoltmetreOutlined, CircuitVoltmetreFilled],
  ...
  contact: [ContactOutlined, ContactFilled],
  ...
  "energy-savings-leaf": [EnergySavingsLeafOutlined, EnergySavingsLeafFilled],
  eraser: [EraserOutlined, EraserFilled],
  error: [ErrorOutlined, ErrorFilled],
  "event-next": [EventNextOutlined, EventNextFilled],
  "event-repeat": [EventRepeatOutlined, EventRepeatFilled],
  explore: [ExploreOutlined, ExploreFilled],
  "explore-off": [ExploreOffOutlined, ExploreOffFilled],
  "export-xls": [ExportXlsOutlined, ExportXlsFilled],
  ...
  handshake: [HandshakeOutlined, HandshakeFilled],
  ...
  journal: [JournalOutlined, JournalFilled],
  ...
  "linked-services": [LinkedServicesOutlined, LinkedServicesFilled],
  "list-alt": [ListAltOutlined, ListAltFilled],
  "location-add": [LocationAddOutlined, LocationAddFilled],
  ...
  version: [VersionOutlined, VersionFilled],
