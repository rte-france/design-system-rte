...
const SvgMoreDown = ({ width = 20, height = 20, fill = 'currentColor', ...props }: IconProps) => {
  return (
    ...
    >
      <path
        fill={fill}
        d="M5.833 14.167H12.5q.354 0 .594.24.24.239.24.593t-.24.594a.8.8 0 0 1-.594.24H5a.8.8 0 0 1-.594-.24.8.8 0 0 1-.24-.594V7.5q0-.354.24-.594T5 6.666t.594.24.24.594zM10 10h6.667q.354 0 .593.24.24.24.24.593 0 .354-.24.594a.8.8 0 0 1-.593.24h-7.5a.8.8 0 0 1-.594-.24.8.8 0 0 1-.24-.594v-7.5q0-.354.24-.593.24-.24.594-.24t.593.24.24.593z"
      />
    </svg>
  );
};
