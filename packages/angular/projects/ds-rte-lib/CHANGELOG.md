...
- 6135f40: ## Changes
  ...
  - (Accordion) add prefers-reduced-motion for chevron rotation
...
- 66ea629: ## Changes
  ...
  - (Radio Button) add exception for disabled & error state used simultanously
...
- 52bc05a: ## Changes
  ...
  - (Card) correct missassigned role attribute
...
- 6984541: ## Changes
  ...
  - (Divider) add Code Connect template files for Figma
  - (Tooltip) add Code Connect template files for Figma
  - (Icon Button) add Code Connect template files for Figma
  - (Tag) add Code Connect template files for Figma
  - (Card) add Code Connect template files for Figma
  - (Avatar) add Code Connect template files for Figma
  - (Header) add Code Connect template files for Figma
  - (Sidenav) add Code Connect template files for Figma
  - (Icon) map Figma Icon instances to Angular Icon components
  - (Angular) create template file for Figma Code Connect
...
- 77a7b3f: ## Changes
  ...
  - (Date Range Picker) synchronize input highlight
  - (Date Range Picker) add Angular component
...
- 00c80a4: ## Changes
  - (Modal) angular - remove the display dependance of custom content with description
...
- 5416f65: ## Changes
  - (Drawer) correct Angular's Drawer custom close behavior
...
- add84d3: ## Changes
  - (Modal) set explicit margin auto to prevent overriding and keep it centered
