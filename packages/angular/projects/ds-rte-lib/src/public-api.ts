...
export * from "./lib/components/icon/icon-registry.service";
...
export * from "./lib/components/side-nav/side-nav.module";
export * from "./lib/components/side-nav/side-nav-header.directive";
export * from "./lib/components/side-nav/side-nav-footer.directive";
