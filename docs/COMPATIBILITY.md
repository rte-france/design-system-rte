...
|--------------|-----------------|--------------|---------------------------|---------|
| `latest` | latest | `^19.2.25` | peer `@design-system-rte/core` (latest) ~1.18.0 | `npm install @design-system-rte/angular @design-system-rte/core` |
...
| `@design-system-rte/angular` | 3.5.1 | peer `@design-system-rte/core` ~1.18.0 |
