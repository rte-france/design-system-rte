import{j as n}from"./jsx-runtime-Cf8x2fCZ.js";import{r as c}from"./index-G8LIXM5I.js";import{I as r,R as b,T as h}from"./Icon-DgLH6pPJ.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";const y=Object.keys(b),I=Object.keys(h),z={title:"Composants/Icon",component:r,tags:["autodocs"],argTypes:{name:{control:"select",options:[...y,...I].sort((a,e)=>a.localeCompare(e)),description:"Nom de l’icône à afficher",defaultValue:"check"},appearance:{control:"select",options:["outlined","filled"],description:"Apparence de l’icône (pour les icônes togglables)",defaultValue:"outlined"},size:{control:{type:"number",min:20,step:1},description:"Taille de l’icône en pixels",defaultValue:20},color:{control:"color",description:"Couleur de l’icône",defaultValue:"#000000"}}},l={args:{name:"add",size:20,color:"#000000",appearance:"outlined"},render:a=>n.jsx(r,{...a,color:"var(--content-primary)","aria-label":a.name})},s={args:{name:"add",size:20},render:a=>n.jsx("div",{style:{display:"flex",flexDirection:"column",flexWrap:"wrap",gap:"10px",height:"700px"},children:y.map(e=>n.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"5px",border:"1px solid #ccc",padding:"5px"},children:[c.createElement(r,{...a,key:e,name:e,"aria-label":e}),n.jsx("span",{children:e})]},e))})},o={args:{name:"add",size:20},render:a=>n.jsx("div",{style:{display:"flex",flexDirection:"column",flexWrap:"wrap",gap:"10px",height:"700px"},children:I.map(e=>n.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"5px",border:"1px solid #ccc",padding:"5px"},children:[c.createElement(r,{...a,key:e,name:e,"aria-label":e}),c.createElement(r,{...a,name:e,key:`${e}-filled`,appearance:"filled","aria-label":`${e}-filled`}),n.jsx("span",{children:e})]},e))})};var i,p,t;l.parameters={...l.parameters,docs:{...(i=l.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    name: "add",
    size: 20,
    color: "#000000",
