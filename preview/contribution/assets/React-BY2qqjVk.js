import{j as e,M as r}from"./index-DilymCAW.js";import{useMDXComponents as s}from"./index-DL7Mpk60.js";/* empty css                   *//* empty css               */import"./iframe-BXz_MUck.js";import"./index-B0WjJBI_.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-Dif16jpf.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";function t(i){const n={code:"code",pre:"pre",strong:"strong",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Design system/Get Started - Kit de migration/React"}),`
`,e.jsx("h1",{id:"migration-react",style:{fontFamily:"Nunito"},children:" Migration depuis Material UI "}),`
...
`,e.jsxs("p",{children:[" ",e.jsx(n.strong,{children:"Material UI"})," utilise des composants React avec des props pour la configuration. Le ",e.jsx(n.strong,{children:"Design System RTE"})," utilise également des composants React avec des props, mais avec une API unifiée et des conventions de nommage cohérentes. "]}),`
`,e.jsx("h4",{id:"material-ui-approach",style:{fontFamily:"Nunito"},children:" Approche Material UI "}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Button, TextField, Checkbox } from '@mui/material';
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Button, TextInput, Checkbox } from '@design-system-rte/react';
...
`,e.jsx("h4",{id:"material-ui-button",style:{fontFamily:"Nunito"},children:" Material UI "}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Button } from '@mui/material';
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Button } from '@design-system-rte/react';
...
`,e.jsx("h4",{id:"material-ui-input",style:{fontFamily:"Nunito"},children:" Material UI "}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { TextField } from '@mui/material';
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { TextInput } from '@design-system-rte/react';
...
`,e.jsx("h4",{id:"material-ui-checkbox",style:{fontFamily:"Nunito"},children:" Material UI "}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Checkbox, FormControlLabel } from '@mui/material';
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Checkbox } from '@design-system-rte/react';
...
/>
`})}),`
`,e.jsx("h3",{id:"modal-migration",style:{fontFamily:"Nunito"},children:" Migration d'un dialogue/modal "}),`
`,e.jsx("h4",{id:"material-ui-modal",style:{fontFamily:"Nunito"},children:" Material UI "}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Dialog, DialogTitle, DialogContent, DialogActions, Button } from '@mui/material';
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Modal, Button } from '@design-system-rte/react';
