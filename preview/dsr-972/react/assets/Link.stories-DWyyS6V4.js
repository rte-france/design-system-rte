import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{w as B,u as N,e as A}from"./index-4rjIhT2C.js";import{B as D,L as c,R as H,a as d,O}from"./chunk-KS7C4IRE-kOmPZtMB.js";import{f as F}from"./testing.utils-r13wRTL2.js";import{N as I}from"./NavigationProvider-DgrdpURC.js";import{L as r}from"./Link-CSfhYy6d.js";import"./index-yBjzXJbu.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./link.constants-kcvANsJQ.js";import"./Icon-VewZnR13.js";import"./index-DJ8f9STe.js";const X={title:"Composants/Link/Link",component:r,tags:["autodocs"],argTypes:{subtle:{control:"boolean"},externalLink:{control:"boolean"},reverse:{control:"boolean"}}},a={args:{label:"Link",href:"#",reverse:!1}},t={args:{label:"Subtle Link",href:"#",subtle:!0},render:n=>e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(r,{...n,label:"Subtle Link",href:"#"}),e.jsx(r,{...n,label:"Subtle Link",href:"#",externalLink:!0})]})},s={args:{label:"External Link",href:"#"},render:n=>e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(r,{...n,label:"External Link",href:"#"}),e.jsx(r,{...n,label:"External Link",href:"#",externalLink:!0})]})},o={args:{label:"External Link",href:"#",reverse:!0,subtle:!0},render:n=>e.jsxs("div",{style:{display:"flex",gap:8,backgroundColor:"black",padding:16},children:[e.jsx(r,{...n,label:"External Link",href:"#"}),e.jsx(r,{...n,label:"External Link",href:"#",externalLink:!0})]})},l={tags:["!autodocs"],args:{label:"Link",href:"#"},play:async({canvasElement:n})=>{const w=B(n).getByRole("link");F(),await N.tab(),A(w).toHaveFocus()}},i={args:{label:"SPA Link",href:"/dashboard"},render:n=>e.jsxs(D,{children:[e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:16},children:e.jsxs(I,{linkComponent:c,children:[e.jsx(r,{...n,customLinkComponent:c,href:"/home",label:"SPA Link via customLinkComponent"}),e.jsx(r,{...n,label:"SPA Link via NavigationProvider"})]})}),e.jsxs(H,{children:[e.jsx(d,{path:"/home",element:e.jsx("div",{children:"Home Page"})}),e.jsx(d,{path:"/dashboard",element:e.jsx("div",{children:"Dashboard Page"})})]}),e.jsx(O,{})]})};var u,m,p;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    label: "Link",
    href: "#",
    reverse: false
...
}`,...(x=(b=t.parameters)==null?void 0:b.docs)==null?void 0:x.source}}};var L,g,h;s.parameters={...s.parameters,docs:{...(L=s.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    label: "External Link",
    href: "#"
  },
...
}`,...(h=(g=s.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var f,v,y;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    label: "External Link",
    href: "#",
    reverse: true,
