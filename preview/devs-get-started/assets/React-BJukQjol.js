import{j as e,M as a}from"./index-BLwalgOQ.js";import{useMDXComponents as c}from"./index-DL7Mpk60.js";import{H as o,B as x,A as t,P as r,a as i}from"./Body-DvZNKV3R.js";import{D as l}from"./GeneralDocs-CClGNfj0.js";import{L as h}from"./List-zE30Gi66.js";/* empty css               */import"./iframe-gvfYNKwb.js";import"./index-B0WjJBI_.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-Dif16jpf.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";function d(s){const n={code:"code",pre:"pre",strong:"strong",...c(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Design system/Get Started - Kit de migration/React"}),`
`,e.jsxs("div",{className:"docs",children:[e.jsx(o,{title:"Migration depuis Material UI"}),e.jsxs(x,{children:[e.jsx(t,{title:"Introduction",id:"introduction",children:e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"24px",padding:"4px 8px"},children:e.jsxs(r,{children:["Ce guide compare l'architecture et les conventions de nommage de ",e.jsx(n.strong,{children:"Material UI (MUI)"})," avec celles du ",e.jsx(n.strong,{children:"Design System RTE"}),". Si vous migrez depuis Material UI, cette documentation vous aidera à comprendre les différences fondamentales entre les deux systèmes."]})})}),e.jsx(t,{title:"Différences architecturales",id:"architectural-differences",children:e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"24px",padding:"4px 8px"},children:e.jsxs(l,{title:"Modèle de composants",headingLevel:3,children:[e.jsxs(r,{children:[e.jsx(n.strong,{children:"Material UI"})," utilise des composants React avec des props pour la configuration. Le ",e.jsx(n.strong,{children:"Design System RTE"})," utilise également des composants React avec des props, mais avec une API unifiée et des conventions de nommage cohérentes."]}),e.jsx(i,{level:4,id:"material-ui-approach",children:"Approche Material UI"}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Button, TextField, Checkbox } from '@mui/material';
...
<Button 
  ...
  onClick={handleClick}
/>
`})})]}),e.jsxs(l,{title:"Migration d'un champ de texte",headingLevel:3,children:[e.jsx(i,{level:4,id:"material-ui-input",children:"Material UI"}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { TextField } from '@mui/material';
...
<TextInput
  ...
  required
/>
`})})]}),e.jsxs(l,{title:"Migration d'une case à cocher",headingLevel:3,children:[e.jsx(i,{level:4,id:"material-ui-checkbox",children:"Material UI"}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Checkbox, FormControlLabel } from '@mui/material';
...
<Checkbox
  ...
  disabled={isDisabled}
/>
`})})]}),e.jsxs(l,{title:"Migration d'un dialogue/modal",headingLevel:3,children:[e.jsx(i,{level:4,id:"material-ui-modal",children:"Material UI"}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { Dialog, DialogTitle, DialogContent, DialogActions, Button } from '@mui/material';
...
/>
`})})]})]})}),e.jsx(t,{title:"Checklist de migration",id:"migration-checklist",children:e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"24px",padding:"4px 8px"},children:e.jsxs(h,{children:[e.jsx("li",{children:"Remplacer les imports Material UI par les imports du Design System RTE"}),e.jsxs("li",{children:["Adapter les props : ",e.jsx("code",{children:"variant"}),", ",e.jsx("code",{children:"size"}),", ",e.jsx("code",{children:"label"})]}),e.jsxs("li",{children:["Ajouter les ",e.jsx("code",{children:"id"})," obligatoires pour l'accessibilité"]}),e.jsxs("li",{children:["Mettre à jour la configuration de thème (attributs ",e.jsx("code",{children:"data-theme"})," et ",e.jsx("code",{children:"data-mode"}),")"]}),e.jsx("li",{children:"Tester l'accessibilité et les comportements interactifs"})]})})})]})]})]})}function I(s={}){const{wrapper:n}={...c(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(d,{...s})}):d(s)}export{I as default};
