import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{T as we,d as Ce}from"./keyboard-test.constants-By8W48aj.js";import{u as p,w as B,a as N,e as f}from"./index-4rjIhT2C.js";import{f as Be}from"./testing.utils-mIZIUNbM.js";import{g as Ee,b as xe,a as Te}from"./auto-placement-hBju0MTR.js";import{E as Pe}from"./keyboard.constants-BverKK8B.js";import{r as t}from"./index-G8LIXM5I.js";import{u as _e}from"./useAnimatedMount-_zPBpYOt.js";import{u as Ae,a as je}from"./useKeydownEscape-BZOC7nI2.js";import{u as Re}from"./useFocusTrap-NapAtiEZ.js";import{B as O}from"./Button-CXM9p_L3.js";import{O as Se}from"./Overlay-BkOVL4Og.js";import{c as I}from"./index-DSdvzt-y.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./timepicker.constants-CzaknwQ-.js";import"./dom.constants-Bk0jVzGk.js";import"./common-button.constants-eNlmcvUj.js";import"./Badge-C3W4NyCk.js";import"./Icon-Bc7wfgCv.js";import"./index-DML4njjH.js";import"./index-BLHw34Di.js";const V=8,k=20,Le=n=>{t.useEffect(()=>(window.addEventListener("scroll",n,!0),()=>{window.removeEventListener("scroll",n,!0)}),[n])},Ne="_popoverTrigger_1f6lj_1",Oe="_popover_1f6lj_1",Ie="_popoverInner_1f6lj_25",Ve="_popoverContentContainer_1f6lj_33",ke="_popoverTitle_1f6lj_40",qe="_popoverContent_1f6lj_33",Fe="_popoverButtonContainer_1f6lj_64",i={popoverTrigger:Ne,popover:Oe,popoverInner:Ie,popoverContentContainer:Ve,popoverTitle:ke,popoverContent:qe,popoverButtonContainer:Fe},Z=t.forwardRef(({children:n,position:r="auto",alignment:l,content:C,arrow:v=!0,title:E,primaryButtonLabel:ee,secondaryButtonLabel:x,className:te="",triggerStyles:oe,closeOnClickOutside:T=!0,closeOnEscape:P=!0,onClickPrimaryButton:_,onClickSecondaryButton:A,...ne},d)=>{const c=t.useRef(null),[a,re]=t.useState(null),[ae,se]=t.useState(r),[ie,le]=t.useState(l),[j,ce]=t.useState({top:0,left:0}),[s,u]=t.useState(!1),{shouldRender:R,isAnimating:ue}=_e(s,150),[pe,S]=t.useState(!1),m=t.useCallback(()=>{if(!c.current||!a)return;const o=r==="auto"?Ee(c.current,a,"top",v?k:V):r,L=l||xe(c.current,a,o),ge=Te(o,c.current,a,v?k:V,L);le(L),ce(ge),se(o)},[r,v,a,l]),de=t.useCallback(()=>{T&&u(!1)},[T]),me=t.useCallback(()=>{P&&u(!1)},[P]);Re(a,R),Ae(de,c.current,a),je(me),Le(m);const fe=t.useCallback(o=>{re(o),typeof d=="function"?d(o):d&&(d.current=o),o&&s&&requestAnimationFrame(()=>{requestAnimationFrame(()=>{m()})})},[d,s,m]);t.useEffect(()=>{s&&a?(m(),S(!0)):S(!1)},[s,a,m]);const ve=o=>{o.key===Pe&&(o.preventDefault(),s||u(!0))},he=o=>{s||(o.preventDefault(),u(!0))},be=()=>{A&&A(),u(!1)},ye=()=>{_&&_(),u(!1)};return e.jsxs("div",{ref:c,className:I(i.popoverTrigger),onClick:he,onKeyDown:ve,style:oe,children:[n,R&&e.jsx(Se,{children:e.jsx("div",{ref:fe,className:I(i.popover,te),role:"dialog","aria-modal":"true","data-arrow":v,"data-position":ae,"data-alignment":ie,"data-open":pe&&ue||void 0,style:{top:`${j.top}px`,left:`${j.left}px`},...ne,children:e.jsxs("div",{className:i.popoverInner,children:[e.jsxs("div",{className:i.popoverContentContainer,children:[E&&e.jsx("div",{className:i.popoverTitle,children:E}),e.jsx("div",{className:i.popoverContent,children:C})]}),e.jsxs("div",{className:i.popoverButtonContainer,children:[x&&e.jsx(O,{className:"popoverButton",onClick:be,label:x,variant:"secondary"}),e.jsx(O,{className:"popoverButton",onClick:ye,label:ee,variant:"primary"})]})]})})})]})});Z.__docgenInfo={description:"",methods:[],displayName:"Popover",props:{content:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},triggerStyles:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""},position:{defaultValue:{value:'"auto"',computed:!1},required:!1},arrow:{defaultValue:{value:"true",computed:!1},required:!1},className:{defaultValue:{value:'""',computed:!1},required:!1},closeOnClickOutside:{defaultValue:{value:"true",computed:!1},required:!1},closeOnEscape:{defaultValue:{value:"true",computed:!1},required:!1}},composes:["CorePopoverProps","Omit"]};const lt={title:"Composants/Popover",component:Z,decorators:[n=>e.jsx("div",{style:{height:"400px",width:"80%",padding:"100px",display:"flex",justifyContent:"center",alignItems:"center"},children:e.jsx(n,{})})],tags:["autodocs"],argTypes:{position:{control:"select",options:["auto","top","bottom","left","right"],description:"Position of the popover relative to trigger",defaultValue:"auto"},alignment:{control:"select",options:["start","center","end"],description:"Alignment of the popover",defaultValue:"start"},arrow:{control:"boolean",description:"Whether to show the arrow",defaultValue:!0},title:{control:"text",description:"Title of the popover",defaultValue:"Popover Title"},content:{control:"text",description:"Content of the popover",defaultValue:"Popover content"},primaryButtonLabel:{control:"text",description:"Label for the primary button",defaultValue:"Close"},secondaryButtonLabel:{control:"text",description:"Label for the secondary button",defaultValue:"Cancel"},children:{table:{disable:!0}},triggerStyles:{table:{disable:!0}},className:{table:{disable:!0}}}},h={args:{position:"auto",arrow:!0,title:"Popover Title",content:"Le Popover est un composant de type superposition (overlay), qui apparaît au clic, au focus ou au survol d'un élément déclencheur (trigger). Il est utilisé pour afficher un contenu contextuel enrichi : aide, options, actions complémentaires…",primaryButtonLabel:"Close",secondaryButtonLabel:"Cancel",children:e.jsx("button",{children:"Open Popover"})}},b={args:{position:"bottom",alignment:"start",arrow:!0,title:"Confirm Action",content:"Are you sure you want to proceed with this action? This cannot be undone.",primaryButtonLabel:"Confirm",secondaryButtonLabel:"Cancel",children:e.jsx("button",{children:"Open Confirmation"})}},y={args:{position:"top",alignment:"center",arrow:!0,content:"This popover has no title, just content and a close button.",primaryButtonLabel:"Got it",children:e.jsx("button",{children:"Show Info"})}},g={args:{position:"right",alignment:"start",arrow:!1,title:"No Arrow",content:"This popover is displayed without an arrow pointer.",primaryButtonLabel:"Close",children:e.jsx("button",{children:"Open Without Arrow"})}},w={args:{position:"auto",arrow:!0,title:"Popover Title",content:"Le Popover est un composant de type superposition (overlay), qui apparaît au clic, au focus ou au survol d'un élément déclencheur (trigger). Il est utilisé pour afficher un contenu contextuel enrichi : aide, options, actions complémentaires…",primaryButtonLabel:"Close",secondaryButtonLabel:"Cancel",children:e.jsx("button",{children:"Open Popover"})},play:async({canvasElement:n})=>{Be(n),await p.tab(),await p.keyboard(we);const r=B(document.body).getByRole("dialog");await N(()=>f(r).toBeVisible()),await p.tab();const l=B(r).getByRole("button",{name:/close/i});f(l).toHaveFocus(),await p.tab();const C=B(r).getByRole("button",{name:/cancel/i});f(C).toHaveFocus(),await p.tab(),f(l).toHaveFocus(),await p.keyboard(Ce),await N(()=>f(r).not.toBeVisible())}};var q,F,K;h.parameters={...h.parameters,docs:{...(q=h.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    position: "auto",
    arrow: true,
    title: "Popover Title",
...
}`,...(X=(U=w.parameters)==null?void 0:U.docs)==null?void 0:X.source}}};const ct=["Default","WithTwoButtons","WithoutTitle","WithoutArrow","KeyboardInteraction"];export{h as Default,w as KeyboardInteraction,b as WithTwoButtons,g as WithoutArrow,y as WithoutTitle,ct as __namedExportsOrder,lt as default};
