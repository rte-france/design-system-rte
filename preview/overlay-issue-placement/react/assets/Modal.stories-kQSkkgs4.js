import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{a as W,T as $,d as L}from"./keyboard-test.constants-By8W48aj.js";import{u as c,w as O,e as m,a as J,f as Q}from"./index-4rjIhT2C.js";import{r as p}from"./index-G8LIXM5I.js";import{f as U}from"./testing.utils-mIZIUNbM.js";import{B as o}from"./Button-CXM9p_L3.js";import{R as X,T as Z}from"./Icon-Bc7wfgCv.js";import{T as ee}from"./Textarea-k1egE4kx.js";import{u as ne,B as te,a as ae,b as oe}from"./useFreezeNavigation-BBBizmtp.js";import{u as se}from"./useAnimatedMount-_zPBpYOt.js";import{u as re,a as le}from"./useKeydownEscape-BZOC7nI2.js";import{u as ie}from"./useFocusTrap-NapAtiEZ.js";import{O as ce}from"./Overlay-BkOVL4Og.js";import{c as de}from"./index-DSdvzt-y.js";import"./index-yBjzXJbu.js";import"./keyboard.constants-BverKK8B.js";import"./_commonjsHelpers-CqkleIqs.js";import"./common-button.constants-eNlmcvUj.js";import"./Badge-C3W4NyCk.js";import"./RequiredIndicator-Cmvl3eZq.js";import"./Link-CAnB1cKs.js";import"./timepicker.constants-CzaknwQ-.js";import"./Divider-BMotkXeQ.js";import"./IconButton-DcIeVO_H.js";import"./dom.constants-Bk0jVzGk.js";import"./index-DML4njjH.js";import"./index-BLHw34Di.js";const B={"modal-container":"_modal-container_1qje1_1","modal-content":"_modal-content_1qje1_41","modal-content-description":"_modal-content-description_1qje1_51"},s=p.forwardRef(({id:n,isOpen:t,title:a,icon:r,iconAppearance:l,description:i,primaryButton:u,secondaryButton:A,size:D="m",closeOnOverlayClick:H=!0,onClose:x,className:K,children:g,...G},y)=>{const{shouldRender:E,isAnimating:j}=se(t,150),[h,Y]=p.useState(null),V=p.useCallback(b=>{Y(b),typeof y=="function"?y(b):y&&(y.current=b)},[y]);return re(H?x:()=>{},h),le(x),ie(h,E),ne(t),e.jsx(e.Fragment,{children:E&&e.jsxs(ce,{children:[e.jsx(te,{isAnimating:j}),e.jsxs("dialog",{ref:V,className:de(B["modal-container"],K),"aria-modal":"true","aria-labelledby":`${n}-modal-title`,"aria-describedby":i?`${n}-modal-desc`:G["aria-describedby"],"data-size":D,"data-open":j,children:[e.jsx(ae,{id:n,title:a,icon:r,iconAppearance:l,onClose:x}),(i||g)&&e.jsxs("div",{className:B["modal-content"],children:[i&&e.jsx("p",{className:B["modal-content-description"],id:`${n}-modal-desc`,children:i}),g]}),e.jsx(oe,{primaryButton:u,secondaryButton:A})]})]})})});s.__docgenInfo={description:"",methods:[],displayName:"Modal",props:{onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},closeOnOverlayClick:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},isOpen:{required:!0,tsType:{name:"boolean"},description:""},children:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},primaryButton:{required:!0,tsType:{name:"ReactReactElement",raw:"React.ReactElement<React.ComponentProps<typeof Button>, typeof Button>",elements:[{name:"ReactComponentProps",raw:"React.ComponentProps<typeof Button>",elements:[{name:"Button"}]},{name:"Button"}]},description:""},secondaryButton:{required:!1,tsType:{name:"ReactReactElement",raw:"React.ReactElement<React.ComponentProps<typeof Button>, typeof Button>",elements:[{name:"ReactComponentProps",raw:"React.ComponentProps<typeof Button>",elements:[{name:"Button"}]},{name:"Button"}]},description:""},size:{defaultValue:{value:'"m"',computed:!1},required:!1}},composes:["coreModalProps","Omit"]};const pe=Object.keys(X),me=Object.keys(Z),De={title:"Composants/Modal",component:s,tags:["autodocs"],argTypes:{id:{control:"text"},title:{control:"text"},icon:{control:"select",options:["",...pe,...me].sort((n,t)=>n.localeCompare(t)),description:"Nom de l’icône à afficher",defaultValue:""},iconAppearance:{control:"select",options:["outlined","filled"]},description:{control:"text"},size:{control:"select",options:["xs","s","m","l","xl"]},closeOnOverlayClick:{control:"boolean"}}},k=Q(),d={args:{id:"modal-1",onClose:()=>{},isOpen:!1,title:"Connect to Wi-Fi",icon:"wifi",iconAppearance:"outlined",description:"Please connect to wifi to synchronise your projects or go to Settings to change your preferences.",primaryButton:e.jsx(o,{variant:"primary",label:"Continue"}),secondaryButton:e.jsx(o,{variant:"neutral",label:"Cancel"}),size:"xs",closeOnOverlayClick:!0},render:n=>{const[t,a]=p.useState(n.isOpen);return e.jsxs(e.Fragment,{children:[e.jsx(o,{variant:"primary",label:"Open Modal",onClick:()=>a(!0)}),e.jsx(s,{...n,isOpen:n.isOpen||t,onClose:()=>a(!1)})]})}},f={args:{...d.args,id:"modal-1",onClose:()=>{},isOpen:!1,title:"Modal Title",icon:"settings",description:"La Modal (ou fenêtre modale) est un composant de superposition (overlay) qui interrompt le flux principal pour afficher un contenu ou solliciter une action de l’utilisateur. Elle nécessite une interaction explicite pour être fermée. Elle se superpose au contenu existant avec un fond atténué (overlay) et capte le focus tant qu’elle est ouverte.",primaryButton:e.jsx(o,{variant:"primary",label:"Continue"}),secondaryButton:e.jsx(o,{variant:"neutral",label:"Cancel"}),size:"xs",closeOnOverlayClick:!0},render:n=>{const[t,a]=p.useState({}),r=i=>{a(u=>({...u,[i]:!0}))},l=i=>{a(u=>({...u,[i]:!1}))};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"12px",marginBottom:"16px"},children:[e.jsx(o,{variant:"primary",label:"Open modal xs",onClick:()=>r("modal-1")}),e.jsx(o,{variant:"primary",label:"Open modal s",onClick:()=>r("modal-2")}),e.jsx(o,{variant:"primary",label:"Open modal m",onClick:()=>r("modal-3")}),e.jsx(o,{variant:"primary",label:"Open modal l",onClick:()=>r("modal-4")}),e.jsx(o,{variant:"primary",label:"Open modal xl",onClick:()=>r("modal-5")})]}),e.jsx(s,{...n,id:"modal-1",size:"xs",isOpen:t["modal-1"],onClose:()=>l("modal-1")}),e.jsx(s,{...n,id:"modal-2",size:"s",isOpen:t["modal-2"],onClose:()=>l("modal-2")}),e.jsx(s,{...n,id:"modal-3",size:"m",isOpen:t["modal-3"],onClose:()=>l("modal-3")}),e.jsx(s,{...n,id:"modal-4",size:"l",isOpen:t["modal-4"],onClose:()=>l("modal-4")}),e.jsx(s,{...n,id:"modal-5",size:"xl",isOpen:t["modal-5"],onClose:()=>l("modal-5")})]})}},C={args:{...d.args,id:"modal-2",onClose:()=>{},isOpen:!1,title:"Préciser le motif du refus",description:"En motivant votre refus, vous aidez votre collaborateur à mieux identifier comment corriger sa demande.",primaryButton:e.jsx(o,{variant:"primary",label:"Envoyer"}),secondaryButton:e.jsx(o,{variant:"neutral",label:"Annuler"}),size:"m",closeOnOverlayClick:!0,children:e.jsx(ee,{resizeable:!0})},render:n=>{const[t,a]=p.useState(n.isOpen);return e.jsxs(e.Fragment,{children:[e.jsx(o,{variant:"primary",label:"Open Modal",onClick:()=>a(!0)}),e.jsx(s,{...n,isOpen:n.isOpen||t,onClose:()=>a(!1)})]})}},v={args:{...d.args,id:"modal-3",onClose:()=>{},isOpen:!1,title:"Delete 3 documents",description:"The selected documents will be deleted.",size:"s",icon:"delete",closeOnOverlayClick:!0,primaryButton:e.jsx(e.Fragment,{})},render:n=>{const[t,a]=p.useState(n.isOpen);return e.jsxs(e.Fragment,{children:[e.jsx(o,{variant:"primary",label:"Open Modal",onClick:()=>a(!0)}),e.jsx(s,{...n,isOpen:n.isOpen||t,onClose:()=>a(!1),primaryButton:e.jsx(o,{variant:"danger",label:"Continue",onClick:k}),secondaryButton:e.jsx(o,{variant:"neutral",label:"Cancel",onClick:()=>a(!1)})})]})},play:async({canvasElement:n})=>{U(n),await c.tab(),await c.keyboard(W);const t=O(document.body).getByRole("dialog");m(t).toBeInTheDocument(),await c.tab();const a=O(t).getByRole("button",{name:/cancel/i});m(a).toHaveFocus(),await c.tab();const r=O(t).getByRole("button",{name:/continue/i});m(r).toHaveFocus(),await c.keyboard($),m(k).toHaveBeenCalled(),await c.tab();const l=O(t).getByTestId("modal-close-button");m(l).toHaveFocus(),await c.keyboard(L),await J(()=>m(t).not.toBeVisible())}};var R,w,S;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    id: "modal-1",
    onClose: () => {},
    isOpen: false,
...
}`,...(S=(w=d.parameters)==null?void 0:w.docs)==null?void 0:S.source}}};var T,I,z;f.parameters={...f.parameters,docs:{...(T=f.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    id: "modal-1",
    onClose: () => {},
...
}`,...(q=(P=v.parameters)==null?void 0:P.docs)==null?void 0:q.source}}};const He=["Default","Sizes","WithCustomContent","KeyboardInteraction"];export{d as Default,v as KeyboardInteraction,f as Sizes,C as WithCustomContent,He as __namedExportsOrder,De as default};
