import{j as e,c as r}from"./index-D0jjT5hZ.js";import{useMDXComponents as i}from"./index-DL7Mpk60.js";import"./iframe-C0rjIiRS.js";import"./index-B0WjJBI_.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-CwPCC0ZT.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";const l=""+new URL("Exemple-D5OVb5gd.png",import.meta.url).href,o=""+new URL("Brands-JyUtiYk4.png",import.meta.url).href,u=""+new URL("Modes-BC5ZKmV_.png",import.meta.url).href,d=""+new URL("ColorChoice-2KDMMUft.png",import.meta.url).href,a=""+new URL("Denomination-Q_8TJAnB.png",import.meta.url).href;function t(s){const n={li:"li",p:"p",strong:"strong",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Design systems/Couleurs"}),`
...
`,e.jsxs("p",{WChaq:!0,children:['e "brand" est ensuite disponible en deux modes : ',e.jsx(n.strong,{children:"Light"})," et ",e.jsx(n.strong,{children:"Dark"}),". Ces termes font référence à la polarité du contraste entre un objet et le fond sur lequel il repose."]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
