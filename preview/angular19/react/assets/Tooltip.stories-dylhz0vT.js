import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{within as d,userEvent as H,expect as c,waitFor as P}from"./index-o3q5y4Vk.js";import{f as k}from"./testing.utils-HTwqi-0x.js";import{T as n}from"./Tooltip-CfBhtBRO.js";import"./index-yBjzXJbu.js";import"./index-BH7jo-UD.js";import"./useGetOverlayLayerLevel-DCKoElYy.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./useAnimatedMount-_zPBpYOt.js";import"./Overlay-DBpi9Esw.js";import"./index-BaBTCQBq.js";import"./index-B6ujFmsw.js";import"./index-DSdvzt-y.js";const Y={title:"Composants/Tooltip",component:n,tags:["autodocs"],argTypes:{position:{control:"select",options:["auto","top","bottom","left","right"]},alignment:{control:"select",options:["start","center","end"]},label:{control:"text"},arrow:{control:"boolean"}},args:{label:"Tooltip Text",position:"top",alignment:"center",arrow:!0},parameters:{layout:"centered"}},M=e.jsx("span",{style:{textDecoration:"underline",textDecorationColor:"#BF4C00",textDecorationThickness:"2px",textUnderlineOffset:"4px",color:"#BF4C00",fontWeight:"bold"},children:"Hover Me!"}),r={args:{label:"Tooltip",children:M}},o={args:r.args,render:t=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:16},children:[e.jsx(n,{...t,position:"top"}),e.jsx(n,{...t,position:"bottom"}),e.jsx(n,{...t,position:"left"}),e.jsx(n,{...t,position:"right"})]})},s={args:r.args,render:t=>e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(n,{...t,alignment:"start"}),e.jsx(n,{...t,alignment:"center"}),e.jsx(n,{...t,alignment:"end"})]})},i={args:r.args,render:t=>e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(n,{...t,arrow:!0}),e.jsx(n,{...t,arrow:!1})]})},a={args:r.args,render:t=>e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8},children:[e.jsx("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"flex-start",gap:8,border:"1px solid red",width:75,height:250},children:e.jsx(n,{...t,position:"auto"})}),e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:8,border:"1px solid red",width:250,height:50},children:e.jsx(n,{...t,position:"auto"})}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"flex-end",gap:8,border:"1px solid red",width:75,height:250},children:e.jsx(n,{...t,position:"auto"})}),e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"flex-end",gap:8,border:"1px solid red",width:250,height:50},children:e.jsx(n,{...t,position:"auto"})})]})},l={args:r.args,render:t=>e.jsx("div",{style:{display:"flex",gap:8},children:e.jsx(n,{...t})}),play:async({canvasElement:t})=>{var p;const A=(p=d(t).queryByText("Hover Me!"))==null?void 0:p.parentElement;k(t),await H.tab();const S=d(document.body).getByRole("tooltip");c(A).toHaveFocus(),await P(()=>c(S).toBeVisible())}};var g,m,x;r.parameters={...r.parameters,docs:{...(g=r.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    label: "Tooltip",
...
}`,...(I=(D=a.parameters)==null?void 0:D.docs)==null?void 0:I.source}}};var E,B,F;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: Default.args,
  render: args => {
    return <div style={{
      display: "flex",
...
}`,...(F=(B=l.parameters)==null?void 0:B.docs)==null?void 0:F.source}}};const Z=["Default","Position","Alignment","Arrow","AutoPlacement","KeyboardInteraction"];export{s as Alignment,i as Arrow,a as AutoPlacement,r as Default,l as KeyboardInteraction,o as Position,Z as __namedExportsOrder,Y as default};
