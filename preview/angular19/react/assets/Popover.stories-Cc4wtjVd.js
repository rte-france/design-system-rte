import{j as t}from"./jsx-runtime-Cf8x2fCZ.js";import{T as A,d as I}from"./keyboard-test.constants-DRUxacrk.js";import{userEvent as o,within as p,waitFor as m,expect as e}from"./index-o3q5y4Vk.js";import{f as j}from"./testing.utils-HTwqi-0x.js";import{P as V}from"./Popover-CVQlKmfi.js";import"./index-yBjzXJbu.js";import"./keyboard.constants-BverKK8B.js";import"./index-BH7jo-UD.js";import"./useGetOverlayLayerLevel-DCKoElYy.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./useAnimatedMount-_zPBpYOt.js";import"./useClickAway-DZ7FPJk_.js";import"./useFocusTrap-C_kwluQD.js";import"./keyboard.constants-D1KJQ2-m.js";import"./timepicker.constants-V9Xrpx_a.js";import"./dom.constants-Bk0jVzGk.js";import"./useKeydownEscape-mLuzHv9M.js";import"./useScrollEvent-BvD0VCKE.js";import"./Button-b4mHgHU2.js";import"./common-button.constants-eNlmcvUj.js";import"./Badge-krITzoP9.js";import"./Icon-DgLH6pPJ.js";import"./index-DSdvzt-y.js";import"./Overlay-DBpi9Esw.js";import"./index-BaBTCQBq.js";import"./index-B6ujFmsw.js";const it={title:"Composants/Popover",component:V,decorators:[u=>t.jsx("div",{style:{height:"400px",width:"80%",padding:"100px",display:"flex",justifyContent:"center",alignItems:"center"},children:t.jsx(u,{})})],tags:["autodocs"],argTypes:{position:{control:"select",options:["auto","top","bottom","left","right"],description:"Position of the popover relative to trigger",defaultValue:"auto"},alignment:{control:"select",options:["start","center","end"],description:"Alignment of the popover",defaultValue:"start"},arrow:{control:"boolean",description:"Whether to show the arrow",defaultValue:!0},title:{control:"text",description:"Title of the popover",defaultValue:"Popover Title"},content:{control:"text",description:"Content of the popover",defaultValue:"Popover content"},primaryButtonLabel:{control:"text",description:"Label for the primary button",defaultValue:"Close"},secondaryButtonLabel:{control:"text",description:"Label for the secondary button",defaultValue:"Cancel"},children:{table:{disable:!0}},triggerStyles:{table:{disable:!0}},className:{table:{disable:!0}}}},r={args:{position:"auto",arrow:!0,title:"Popover Title",content:"Le Popover est un composant de type superposition (overlay), qui apparaît au clic, au focus ou au survol d'un élément déclencheur (trigger). Il est utilisé pour afficher un contenu contextuel enrichi : aide, options, actions complémentaires…",primaryButtonLabel:"Close",secondaryButtonLabel:"Cancel",children:t.jsx("button",{children:"Open Popover"})}},a={args:{position:"bottom",alignment:"start",arrow:!0,title:"Confirm Action",content:"Are you sure you want to proceed with this action? This cannot be undone.",primaryButtonLabel:"Confirm",secondaryButtonLabel:"Cancel",children:t.jsx("button",{children:"Open Confirmation"})}},i={args:{position:"top",alignment:"center",arrow:!0,content:"This popover has no title, just content and a close button.",primaryButtonLabel:"Got it",children:t.jsx("button",{children:"Show Info"})}},s={args:{position:"right",alignment:"start",arrow:!1,title:"No Arrow",content:"This popover is displayed without an arrow pointer.",primaryButtonLabel:"Close",children:t.jsx("button",{children:"Open Without Arrow"})}},c={args:{position:"auto",arrow:!0,title:"Popover Title",content:"Le Popover est un composant de type superposition (overlay), qui apparaît au clic, au focus ou au survol d'un élément déclencheur (trigger). Il est utilisé pour afficher un contenu contextuel enrichi : aide, options, actions complémentaires…",primaryButtonLabel:"Close",secondaryButtonLabel:"Cancel",children:t.jsx("button",{children:"Open Popover"})},play:async({canvasElement:u})=>{j(u),await o.tab(),await o.keyboard(A);const n=p(document.body).getByRole("dialog");await m(()=>e(n).toBeVisible()),await o.tab();const l=p(n).getByRole("button",{name:/close/i});e(l).toHaveFocus(),await o.tab();const S=p(n).getByRole("button",{name:/cancel/i});e(S).toHaveFocus(),await o.tab(),e(l).toHaveFocus(),await o.keyboard(I),await m(()=>e(n).not.toBeVisible())}};var d,b,h;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    position: "auto",
    arrow: true,
    title: "Popover Title",
...
}`,...(h=(b=r.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};var y,v,w;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    position: "bottom",
    alignment: "start",
    arrow: true,
...
}`,...(w=(v=a.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var f,g,B;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    position: "top",
    alignment: "center",
    arrow: true,
...
}`,...(P=(L=c.parameters)==null?void 0:L.docs)==null?void 0:P.source}}};const st=["Default","WithTwoButtons","WithoutTitle","WithoutArrow","KeyboardInteraction"];export{r as Default,c as KeyboardInteraction,a as WithTwoButtons,s as WithoutArrow,i as WithoutTitle,st as __namedExportsOrder,it as default};
