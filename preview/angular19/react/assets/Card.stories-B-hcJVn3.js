import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{within as X,expect as u,userEvent as Z,fn as $}from"./index-o3q5y4Vk.js";import{B as s}from"./Button-b4mHgHU2.js";import{S as v,E as C}from"./keyboard.constants-BverKK8B.js";import{r as ee}from"./index-G8LIXM5I.js";import{u as te}from"./useActiveKeyboard-DaOmFJe_.js";import"./index-yBjzXJbu.js";import"./index-BH7jo-UD.js";import"./common-button.constants-eNlmcvUj.js";import"./Badge-krITzoP9.js";import"./Icon-DgLH6pPJ.js";import"./index-DSdvzt-y.js";import"./_commonjsHelpers-CqkleIqs.js";const R="480px",ae={width:{control:"text",description:"Width of the card (e.g. '480px', '50%'). Defaults to 480px."},cardType:{control:"select",options:["default","outlined"],description:"Type of card styling"},clickable:{control:"boolean",description:"Whether the card is clickable"},disabled:{control:"boolean",description:"Whether the card is disabled"}},ne=[{label:"Extra Small",width:"240px"},{label:"Small",width:"360px"},{label:"Medium",width:"480px"},{label:"Large",width:"600px"},{label:"Extra Large",width:"720px"}],re=[{cardType:"default",title:"Default Card",description:"This card uses the default styling with elevation shadow."},{cardType:"outlined",title:"Outlined Card",description:"This card uses outlined styling with a border instead of shadow."}],l={width:R,cardType:"default",clickable:!1,disabled:!1},V={...l,clickable:!0},ie={...l,clickable:!0,disabled:!0},le="_card_t1qi5_1",se={card:le},n=ee.forwardRef(({width:t=R,cardType:a="default",clickable:r=!1,disabled:d=!1,children:o,onClick:i,...N},U)=>{const Y=f=>{!d&&r&&(f.key===v||f.key===C)&&(f.preventDefault(),i==null||i())},G=()=>{!d&&r&&(i==null||i())},{onKeyDown:F,onKeyUp:J,onBlur:Q}=te({onKeyUp:Y},{interactiveKeyCodes:[v,C]});return e.jsx("div",{ref:U,className:se.card,style:{width:t},"data-card-type":a,"data-clickable":r,"data-disabled":d,tabIndex:r?0:-1,onClick:G,onKeyDown:F,onKeyUp:J,onBlur:Q,...N,children:o})});n.__docgenInfo={description:"",methods:[],displayName:"Card",props:{onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},width:{defaultValue:{value:'"480px"',computed:!1},required:!1},cardType:{defaultValue:{value:'"default"',computed:!1},required:!1},clickable:{defaultValue:{value:"false",computed:!1},required:!1},disabled:{defaultValue:{value:"false",computed:!1},required:!1}},composes:["CardPropsCore","Omit"]};const ke={title:"Composants/Card",component:n,tags:["autodocs"],argTypes:{...ae,onClick:{action:"clicked"}},args:{onClick:$()}},de=e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Card Title"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This is a sample card with some content. You can add any content you want here, including text, images, buttons, or other components."})]}),c={args:{...l,children:de}},p={args:l,render:t=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:ne.map(a=>e.jsx(n,{...t,width:a.width,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 8px 0",fontSize:"16px",fontWeight:"600"},children:a.label}),e.jsx("p",{style:{margin:"0",color:"#666",fontSize:"14px"},children:a.width})]})},a.width))})},h={args:l,render:t=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:re.map(a=>e.jsx(n,{...t,cardType:a.cardType,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 8px 0",fontSize:"18px",fontWeight:"600"},children:a.title}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:a.description})]})},a.cardType))})},g={args:V,render:t=>e.jsx(n,{...t,onClick:t.onClick,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Clickable Card"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This card is clickable. Click anywhere on the card to trigger an action."}),e.jsx("p",{style:{margin:"0",color:"#999",fontSize:"14px"},children:"Check the console or Actions panel to see the click event."})]})}),play:async({canvasElement:t,args:a})=>{const o=X(t).getByText("Clickable Card").closest("[data-clickable='true']");u(o).toBeInTheDocument(),await Z.click(o),u(a.onClick).toHaveBeenCalled()}},x={args:ie,render:t=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(n,{...t,cardType:"default",children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Disabled Default Card"}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:"This card is disabled and cannot be clicked."})]})}),e.jsx(n,{...t,cardType:"outlined",children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Disabled Outlined Card"}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:"This outlined card is also disabled."})]})})]}),play:async({canvasElement:t})=>{const a=t.querySelectorAll("[data-disabled='true']");u(a.length).toBeGreaterThan(0),a.forEach(r=>{u(r).toHaveAttribute("data-disabled","true")})}},y={args:l,render:t=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(n,{...t,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Primary Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with primary button variant"}),e.jsx(s,{variant:"primary",label:"Primary Action",onClick:()=>console.log("Primary clicked")})]})}),e.jsx(n,{...t,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Secondary Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with secondary button variant"}),e.jsx(s,{variant:"secondary",label:"Secondary Action",onClick:()=>console.log("Secondary clicked")})]})}),e.jsx(n,{...t,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Multiple Buttons"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with multiple button actions"}),e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx(s,{variant:"primary",label:"Save",onClick:()=>console.log("Save clicked")}),e.jsx(s,{variant:"neutral",label:"Cancel",onClick:()=>console.log("Cancel clicked")})]})]})})]})},m={args:V,render:t=>e.jsx(n,{...t,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Clickable Card with Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This card is clickable. Click anywhere on the card to trigger the card click event. The button inside will stop propagation, so clicking it won't trigger the card click."}),e.jsx(s,{variant:"primary",label:"Action Button",onClick:a=>{a.stopPropagation(),console.log("Button clicked inside card")}})]})})};var b,k,S;c.parameters={...c.parameters,docs:{...(b=c.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    ...defaultStoryArgs,
