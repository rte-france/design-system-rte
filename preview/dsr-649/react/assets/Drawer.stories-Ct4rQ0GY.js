import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{w as T,u as X,e as K,a as oe}from"./index-4rjIhT2C.js";import{r as l}from"./index-G8LIXM5I.js";import{B as c}from"./Button-CMRW5oAT.js";import{I as w}from"./IconButton-O5Q6mfOY.js";import{B as ue,b as le,a as ce}from"./BaseHeader-ByTmVxcm.js";import{u as me}from"./useAnimatedMount-_zPBpYOt.js";import{u as de,a as pe,b as ge}from"./useKeydownEscape-CE1Mjiyw.js";import{D as ve}from"./Divider-BMotkXeQ.js";import{O as he}from"./Overlay-BI5SO8Nq.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./common-button.constants-eNlmcvUj.js";import"./Badge-b6ITl72-.js";import"./Icon-DjEid3Hw.js";import"./index-DSdvzt-y.js";import"./dom.constants-41SiyeDe.js";import"./index-DML4njjH.js";import"./index-BLHw34Di.js";const fe=240,A=4,f={MISSING_HEADER_OR_TITLE:"Drawer: You must provide either a title or a custom header.",MISSING_FOOTER_OR_PRIMARY:"Drawer: You must provide either a primaryButtonLabel or a custom footer.",RESPONSIVE_NEEDS_MAIN_CONTENT:"Drawer: You should provide your content as children when using responsive position to avoid empty space next to the drawer.",MODAL_MUST_NOT_HAVE_MAIN_CONTENT:"Drawer: You should not provide children when using modal position."};function be(t){if(!t.hasCustomHeader&&!t.hasTitle)return f.MISSING_HEADER_OR_TITLE;if(!t.hasCustomFooter&&!t.hasPrimaryButtonLabel)return f.MISSING_FOOTER_OR_PRIMARY;if(t.position==="responsive"&&!t.hasMainContent)return f.RESPONSIVE_NEEDS_MAIN_CONTENT;if(t.position==="modal"&&t.hasMainContent)return f.MODAL_MUST_NOT_HAVE_MAIN_CONTENT}function xe(t,n){return!t&&!!n}function we(t,n){return!t&&!!n}const ye="_drawer_1nljj_1",o={"drawer-responsive-container":"_drawer-responsive-container_1nljj_1",drawer:ye,"drawer-content":"_drawer-content_1nljj_44","drawer-toggle":"_drawer-toggle_1nljj_52","drawer-footer":"_drawer-footer_1nljj_61","drawer-header-content":"_drawer-header-content_1nljj_68"},p=({id:t,title:n,icon:a,iconAppearance:s,isOpen:r,onClose:y,onClickToggle:J,closeOnOverlayClick:Z=!1,primaryButtonLabel:R,secondaryButtonLabel:D,isCollapsible:C=!1,content:ee,header:O,footer:g,position:v,width:h,children:_,fixedHeader:m,closeOnEscape:te=!1,isClosable:ae=!0,...S})=>{var V;const{shouldRender:E,isAnimating:i}=me(r,fe),d=l.useRef(null),N=l.useRef(null),j=l.useRef(null),ne=((V=d.current)==null?void 0:V.clientWidth)||0;de(Z&&v==="modal"?y:()=>{},d.current),pe(te?y:()=>{}),ge(d.current,E);const ie=xe(O,n),se=we(g,R),M=be({hasCustomHeader:O!==void 0,hasTitle:!!n,hasCustomFooter:g!==void 0,hasPrimaryButtonLabel:!!R,position:v,hasMainContent:!!_});if(M)return console.warn(M),null;const I=(re=0)=>i?`translateX(-${ne+re}px)`:"none",q=()=>{r&&N.current&&N.current.focus(),!r&&j.current&&j.current.focus(),J()},P=()=>e.jsxs(e.Fragment,{children:[C&&e.jsx(w,{ref:j,className:o["drawer-toggle"],style:{transform:I(A)},name:r?"right-panel-close":"right-panel-open",size:"l",variant:"primary",onClick:q,"aria-label":`Close drawer ${t}`}),ie?e.jsx(ce,{id:t,title:n,icon:a,iconAppearance:s,onClose:y,isClosable:ae}):e.jsx(e.Fragment,{children:O})]}),B=()=>e.jsx("div",{className:o["drawer-content"],"data-fixed-header":m,tabIndex:-1,children:ee}),k=()=>e.jsx(e.Fragment,{children:m?e.jsxs(e.Fragment,{children:[e.jsx(P,{}),e.jsx(B,{})]}):e.jsxs("div",{className:o["drawer-header-content"],children:[e.jsx(P,{}),e.jsx(B,{})]})}),U=()=>e.jsx("div",{className:o["drawer-footer"],"data-fixed-header":m,children:se?e.jsx(le,{primaryButton:e.jsx(c,{label:R,variant:"primary"}),secondaryButton:D?e.jsx(c,{label:D,variant:"secondary"}):void 0}):g&&e.jsx(e.Fragment,{children:g})});return e.jsx(e.Fragment,{children:v==="responsive"?e.jsx(e.Fragment,{children:e.jsxs("div",{className:o["drawer-responsive-container"],children:[C&&e.jsx(w,{className:o["drawer-toggle"],style:{position:"absolute",top:24,right:4,opacity:i?0:1,transform:I(A)},name:"right-panel-open",size:"l",variant:"primary",onClick:q,"aria-label":`Close drawer ${t}`}),e.jsx(ve,{orientation:"vertical",style:{position:"absolute",right:"0px",transition:"transform 240ms ease-out",visibility:i?"visible":"hidden",transform:I()}}),e.jsxs("div",{className:o.drawer,ref:d,"data-open":i,role:"region","aria-labelledby":`${t}-drawer-title`,"data-position":v,"data-fixed-header":m,style:{width:h,transform:i?"none":`translateX(${h||"100%"})`,visibility:i?"visible":"hidden"},...S,children:[e.jsx(k,{}),e.jsx(U,{})]}),e.jsx("div",{className:o["drawer-children"],"data-open":i,style:{height:"100%",transition:"margin-right 240ms ease-out",marginRight:i?h:0,maxHeight:i?"100vh":void 0,overflowY:i?"auto":void 0},children:_})]})}):e.jsxs(e.Fragment,{children:[C&&e.jsx(w,{ref:N,className:o["drawer-toggle"],style:{position:"absolute",top:24,right:4,opacity:i?0:1},name:"right-panel-open",size:"l",variant:"primary",onClick:q,"aria-label":`Close drawer ${t}`}),E&&e.jsxs(he,{freezeNavigation:!0,children:[e.jsx(ue,{isAnimating:i}),e.jsxs("div",{ref:d,className:o.drawer,"data-open":i,"data-fixed-header":m,role:"dialog","aria-modal":"true","aria-labelledby":`${t}-drawer-title`,style:{width:h},...S,children:[e.jsx(k,{}),e.jsx(U,{})]})]})]})})};p.__docgenInfo={description:"",methods:[],displayName:"Drawer",props:{header:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},footer:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},content:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},children:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},width:{required:!1,tsType:{name:"string"},description:""},closeOnOverlayClick:{defaultValue:{value:"false",computed:!1},required:!1},isCollapsible:{defaultValue:{value:"false",computed:!1},required:!1},closeOnEscape:{defaultValue:{value:"false",computed:!1},required:!1},isClosable:{defaultValue:{value:"true",computed:!1},required:!1}},composes:["coreDrawerProps","Omit"]};const Fe={title:"Composants/Drawer",component:p,tags:["autodocs"],argTypes:{id:{control:"text"},title:{control:"text"},icon:{control:"text"},iconAppearance:{control:"select",options:["outlined","filled"]},closeOnOverlayClick:{control:"boolean"},primaryButtonLabel:{control:"text"},secondaryButtonLabel:{control:"text"},isCollapsible:{control:"boolean"},position:{control:"select",options:["modal","responsive"]},fixedHeader:{control:"boolean"}}},u={args:{isOpen:!1,onClose(){console.log("Drawer closed")},id:"example-drawer",title:"Example Drawer",icon:"settings",iconAppearance:"outlined",primaryButtonLabel:"Confirm",secondaryButtonLabel:"Cancel",isCollapsible:!1,position:"modal",fixedHeader:!0,width:"400px",isClosable:!0,onClickToggle(){console.log("Toggle drawer")},content:e.jsx("span",{style:{fontFamily:"arial",fontSize:"14px",lineHeight:"20px",color:"var(--content-primary)"},children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis urna lacus. Praesent tempor nisl non arcu molestie gravida. Nam nec tincidunt sapien. Vestibulum a malesuada nisl. Maecenas nec magna nisi. Etiam tempus massa lobortis massa blandit ultricies. Ut in odio ex. Quisque a feugiat tellus. Proin vehicula risus non magna hendrerit mollis. Ut efficitur maximus sagittis. Integer eget est eget metus imperdiet lobortis. Cras scelerisque pharetra purus consectetur sollicitudin. Ut rhoncus, ipsum porta tempus pharetra, quam massa maximus sem, ac tempus ipsum sapien ac nisl. Mauris in neque vitae metus congue varius. Proin porta elementum bibendum. Vivamus venenatis sem metus, eu pulvinar tellus varius eu. Quisque vel condimentum nisl. Quisque maximus convallis elit ut vulputate. Integer eget laoreet velit. Donec viverra ac justo ut gravida. Nunc viverra tristique enim sit amet blandit. Curabitur odio nunc, ultricies euismod tortor id, ornare tincidunt leo. Ut at porta risus, ac condimentum nisi. Morbi ac nunc eu metus vehicula lacinia a at est. Praesent quis justo eu mauris finibus porta placerat ut metus. Sed vestibulum pretium dui id ultrices. Integer vulputate turpis sed turpis suscipit sagittis sed sed odio. Vestibulum eget eleifend eros, ut lobortis velit. Ut ac massa sed velit ullamcorper posuere. Sed a auctor eros. Maecenas ligula nunc, consectetur eu nulla vitae, aliquet molestie nibh. Vivamus eu ultricies ex. Integer sodales tempor nisi, non maximus velit hendrerit eu. Proin pretium sagittis odio sit amet tincidunt. Suspendisse at risus pellentesque, bibendum magna eget, congue mi. Morbi odio enim, pulvinar vitae purus sit amet, dapibus porttitor quam. Donec maximus lectus ac felis lobortis pulvinar. Maecenas vel blandit odio. Nulla volutpat, nisi eget elementum lobortis, enim mi ornare sapien, at tempor tortor nisl id mi. Curabitur et commodo dui. Aenean a viverra dui. Praesent ac nisi molestie, posuere nisl vitae, consequat erat. Proin et iaculis mi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elit metus, maximus sit amet laoreet at, hendrerit eu ipsum. Mauris vulputate et leo sed convallis. Sed id eros nulla. Praesent ex tellus, pulvinar ac ornare vitae, dapibus feugiat mauris. Sed leo mauris, tempus et interdum sit amet, luctus sed ligula."})},render:t=>{const[n,a]=l.useState(t.isOpen),s=()=>{a(r=>!r)};return e.jsxs(e.Fragment,{children:[e.jsx(c,{label:"Open drawer",onClick:()=>a(!0)}),e.jsx(p,{...t,isOpen:n,onClose:()=>a(!1),onClickToggle:s})]})},play:async({canvasElement:t})=>{const a=await T(t).getByRole("button",{name:"Open drawer"});await X.click(a);const s=T(document.body).getByRole("dialog");K(s).toBeInTheDocument()}},b={args:{...u.args,id:"responsive-drawer",title:"Responsive Drawer",position:"responsive",icon:void 0,isClosable:!0},render:t=>{const[n,a]=l.useState(t.isOpen),s=()=>{a(r=>!r)};return e.jsx("div",{style:{border:"1px solid #ccc",width:"600px",height:"500px"},children:e.jsx(p,{...t,isOpen:n,onClose:()=>a(!1),onClickToggle:s,content:e.jsx("span",{style:{fontFamily:"arial",fontSize:"14px",lineHeight:"20px",color:"var(--content-primary)"},children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis urna lacus. Praesent tempor nisl non arcu molestie gravida. Nam nec tincidunt sapien. Vestibulum a malesuada nisl. Maecenas nec magna nisi. Etiam tempus massa lobortis massa blandit ultricies. Ut in odio ex. Quisque a feugiat tellus. Proin vehicula risus non magna hendrerit mollis. Ut efficitur maximus sagittis. Integer eget est eget metus imperdiet lobortis. Cras scelerisque pharetra purus consectetur sollicitudin. Ut rhoncus, ipsum porta tempus pharetra, quam massa maximus sem, ac tempus ipsum sapien ac nisl. Mauris in neque vitae metus congue varius. Proin porta elementum bibendum. Vivamus venenatis sem metus, eu pulvinar tellus varius eu. Quisque vel condimentum nisl. Quisque maximus convallis elit ut vulputate. Integer eget laoreet velit. Donec viverra ac justo ut gravida. Nunc viverra tristique enim sit amet blandit. Curabitur odio nunc, ultricies euismod tortor id, ornare tincidunt leo. Ut at porta risus, ac condimentum nisi. Morbi ac nunc eu metus vehicula lacinia a at est. Praesent quis justo eu mauris finibus porta placerat ut metus. Sed vestibulum pretium dui id ultrices. Integer vulputate turpis sed turpis suscipit sagittis sed sed odio. Vestibulum eget eleifend eros, ut lobortis velit. Ut ac massa sed velit ullamcorper posuere. Sed a auctor eros. Maecenas ligula nunc, consectetur eu nulla vitae, aliquet molestie nibh. Vivamus eu ultricies ex. Integer sodales tempor nisi, non maximus velit hendrerit eu. Proin pretium sagittis odio sit amet tincidunt."}),width:"400px",children:e.jsxs("div",{style:{height:"100%",display:"flex",flexDirection:"column",gap:"16px",padding:"16px"},children:[e.jsx(c,{label:"Open drawer",onClick:()=>a(!0)}),e.jsx("span",{style:{fontFamily:"arial",fontSize:"14px",lineHeight:"20px",color:"var(--content-primary)"},children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis urna lacus. Praesent tempor nisl non arcu molestie gravida. Nam nec tincidunt sapien. Vestibulum a malesuada nisl. Maecenas nec magna nisi. Etiam tempus massa lobortis massa blandit ultricies. Ut in odio ex. Quisque a feugiat tellus. Proin vehicula risus non magna hendrerit mollis. Ut efficitur maximus sagittis. Integer eget est eget metus imperdiet lobortis. Cras scelerisque pharetra purus consectetur sollicitudin. Ut rhoncus, ipsum porta tempus pharetra, quam massa maximus sem, ac tempus ipsum sapien ac nisl. Mauris in neque vitae metus congue varius. Proin porta elementum bibendum. eros. Nam nec tincidunt sapien. Vestibulum a malesuada nisl. Maecenas nec magna nisi. Etiam tempus massa lobortis massa blandit ultricies. Ut in odio ex. Quisque a feugiat tellus. Proin vehicula risus non magna hendrerit mollis."})]})})})},play:async({canvasElement:t})=>{const n=T(t),a=await n.getByRole("button",{name:"Open drawer"});await X.click(a),await oe(()=>{const s=n.getByRole("region");K(s).toBeInTheDocument()})}},x={args:{...u.args,closeOnEscape:!0,id:"custom-header-footer-drawer"},render:t=>{const[n,a]=l.useState(t.isOpen),s=()=>{a(r=>!r)};return e.jsxs(e.Fragment,{children:[e.jsx(c,{label:"Open drawer",onClick:()=>a(!0)}),e.jsx(p,{...t,isOpen:n,onClose:()=>a(!1),onClickToggle:s,header:e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:"8px",width:"100%"},children:[e.jsx("span",{style:{fontSize:"16px",fontWeight:"bold",fontFamily:"arial",color:"var(--content-primary)"},children:"Custom Header"}),e.jsx(w,{name:"close",size:"m",onClick:()=>a(!1),"aria-label":"Close drawer"})]}),footer:e.jsx("div",{style:{display:"flex",justifyContent:"flex-end",gap:"8px",boxSizing:"border-box",width:"100%"},children:e.jsx(c,{label:"Custom Action",variant:"primary"})})})]})}};var F,H,L;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    isOpen: false,
    onClose() {
...
}`,...(L=(H=u.parameters)==null?void 0:H.docs)==null?void 0:L.source}}};var z,Q,Y;b.parameters={...b.parameters,docs:{...(z=b.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(Y=(Q=b.parameters)==null?void 0:Q.docs)==null?void 0:Y.source}}};var $,G,W;x.parameters={...x.parameters,docs:{...($=x.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    closeOnEscape: true,
...
}`,...(W=(G=x.parameters)==null?void 0:G.docs)==null?void 0:W.source}}};const He=["Default","Responsive","CustomHeaderFooter"];export{x as CustomHeaderFooter,u as Default,b as Responsive,He as __namedExportsOrder,Fe as default};
