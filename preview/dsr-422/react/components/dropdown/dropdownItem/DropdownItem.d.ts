...
export declare const DropdownItem: ({ label, link, leftIcon, trailingText, disabled, hasSeparator, hasIndent, children, badgeCount, badgeContent, badgeIcon, badgeType, badgeSize, showBadge, onClick, ...props }: DropdownItemProps) => import("react/jsx-runtime").JSX.Element;
export {};
