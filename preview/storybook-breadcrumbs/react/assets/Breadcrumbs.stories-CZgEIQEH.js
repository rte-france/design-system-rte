import{j as a}from"./jsx-runtime-Cf8x2fCZ.js";import{T as K,a as W,b as C}from"./keyboard-test.constants-D-GvhFnl.js";import{w as p,u as c,a as g,e as o}from"./index-DCXJbAaW.js";import{B as n}from"./Breadcrumbs-weKt95ye.js";import"./index-yBjzXJbu.js";import"./keyboard.constants-ep-ZHn_7.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./DropdownItem-CTbBVvM1.js";import"./useActiveKeyboard-BPEscCvd.js";import"./Divider-B2eUObs8.js";import"./Icon-DjEid3Hw.js";import"./auto-placement-C6RxYMtA.js";import"./useAnimatedMount-_zPBpYOt.js";import"./Overlay-CwMsU-JP.js";import"./index-CRX2eyIH.js";import"./index-B6ujFmsw.js";import"./index-DSdvzt-y.js";import"./IconButton-DLtPB6Kc.js";import"./Badge-yqZBktoR.js";import"./Link-DbCKFFRz.js";import"./Tooltip-DfjbCIrb.js";const oe={title:"Composants/Breadcrumbs/Breadcrumbs",component:n,tags:["autodocs"],argTypes:{items:{control:"object"},ariaLabel:{control:"text"},breadcrumbItemMaxWidth:{control:"number"}}},G=[{label:"Home",link:"/"},{label:"Products",link:"/products"},{label:"Electronics",link:"/products/electronics"},{label:"Smartphones",link:"/products/electronics/smartphones"}],s={args:{items:G},render:e=>a.jsx(n,{...e,"data-testid":"breadcrumbs"})},u={args:{...s.args},render:e=>a.jsx(n,{...e,"data-testid":"breadcrumbs"}),play:async({canvasElement:e,args:d})=>{const r=p(e).getByTestId("breadcrumbs").querySelectorAll("div"),_=r[r.length-1].querySelector("a");d.items.forEach(async()=>{await c.tab()}),await g(()=>o(_).toHaveFocus()),await c.tab({shift:!0}),o(r[r.length-2].querySelector("a")).toHaveFocus()}},m={args:{...s.args,items:[...s.args.items.slice(0,2)]},render:e=>a.jsxs(a.Fragment,{children:[a.jsx(n,{...e,"data-testid":"breadcrumbs"}),a.jsx(n,{...s.args,"data-testid":"breadcrumbs-truncated"})]}),play:async({canvasElement:e})=>{const d=p(e),t=d.getByTestId("breadcrumbs"),r=d.getByTestId("breadcrumbs-truncated");o(p(t).queryByTestId("show-more")).not.toBeInTheDocument(),o(p(r).queryByTestId("show-more")).toBeInTheDocument()}},i={args:{...s.args,breadcrumbItemMaxWidth:50},render:e=>a.jsx(n,{...e,"data-testid":"breadcrumbs"})},b={args:{...s.args},render:e=>a.jsxs(a.Fragment,{children:[a.jsx(n,{...e,items:e.items.slice(0,1)}),a.jsx(n,{...e,items:e.items.slice(0,2)}),a.jsx(n,{...e,items:e.items.slice(0,3)}),a.jsx(n,{...e,items:e.items})]})},l={args:{...s.args,items:[...s.args.items,{label:"FancyBrand Phone",link:"/products/electronics/smartphones/fancybrand-phone"}]},render:e=>a.jsx(n,{...e,"data-testid":"breadcrumbs"}),play:async()=>{await c.tab(),await c.tab(),await c.keyboard(K);const d=CSS.escape("breadcrumbs-truncated-listFil d'Ariane"),t=document.querySelector(`[data-dropdown-id="${d}"]`);o(t).toBeInTheDocument(),await c.tab(),await g(()=>{var r;return o((r=t==null?void 0:t.querySelector("ul"))==null?void 0:r.children[0]).toHaveFocus()}),await c.keyboard(W),await g(()=>{var r;return o((r=t==null?void 0:t.querySelector("ul"))==null?void 0:r.children[1]).toHaveFocus()}),await c.keyboard(C),await g(()=>{var r;return o((r=t==null?void 0:t.querySelector("ul"))==null?void 0:r.children[0]).toHaveFocus()})}};var y,h,w;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    items: mockItems
  },
...
}`,...(E=(T=u.parameters)==null?void 0:T.docs)==null?void 0:E.source}}};var B,x,S;m.parameters={...m.parameters,docs:{...(B=m.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(S=(x=m.parameters)==null?void 0:x.docs)==null?void 0:S.source}}};var I,f,F;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(F=(f=i.parameters)==null?void 0:f.docs)==null?void 0:F.source}}};var D,q,j;b.parameters={...b.parameters,docs:{...(D=b.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  render: args => {
...
}`,...(N=(H=l.parameters)==null?void 0:H.docs)==null?void 0:N.source}}};const de=["Default","KeyboardNavigation","Truncated","maxWidthBreadcrumbItem","MultipleElements","KeyboardNavigationWithDropdown"];export{s as Default,u as KeyboardNavigation,l as KeyboardNavigationWithDropdown,b as MultipleElements,m as Truncated,de as __namedExportsOrder,oe as default,i as maxWidthBreadcrumbItem};
