import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{d as fe}from"./keyboard-test.constants-By8W48aj.js";import{w as u,u as d,e as o,a as k,f as Y}from"./index-4rjIhT2C.js";import{r as R}from"./index-G8LIXM5I.js";import{B as O}from"./Button-CXM9p_L3.js";import{I as P}from"./IconButton-DcIeVO_H.js";import"./timepicker.constants-Dc9ut5mB.js";import{B as xe,b as Ce,a as Re}from"./BaseHeader-CTDRf_4H.js";import{u as Oe}from"./useAnimatedMount-_zPBpYOt.js";import{u as Be,a as ke}from"./useKeydownEscape-BZOC7nI2.js";import{u as Ee}from"./useFocusTrap-DG09Z6i4.js";import{D as Ne}from"./Divider-BMotkXeQ.js";import{O as Ie}from"./Overlay-BI5SO8Nq.js";import"./index-yBjzXJbu.js";import"./keyboard.constants-BverKK8B.js";import"./_commonjsHelpers-CqkleIqs.js";import"./common-button.constants-eNlmcvUj.js";import"./Badge-C3W4NyCk.js";import"./Icon-Bc7wfgCv.js";import"./index-DSdvzt-y.js";import"./dom.constants-Bk0jVzGk.js";import"./index-DML4njjH.js";import"./index-BLHw34Di.js";const De=240,je=4,I={MISSING_HEADER_OR_TITLE:"Drawer: You must provide either a title or a custom header.",MISSING_FOOTER_OR_PRIMARY:"Drawer: You must provide either a primaryButtonLabel or a custom footer.",RESPONSIVE_NEEDS_MAIN_CONTENT:"Drawer: You should provide your content as children when using responsive position to avoid empty space next to the drawer.",MODAL_MUST_NOT_HAVE_MAIN_CONTENT:"Drawer: You should not provide children when using modal position."},qe=[{condition:t=>!t.hasCustomHeader&&!t.hasTitle,issue:I.MISSING_HEADER_OR_TITLE},{condition:t=>!t.hasCustomFooter&&!t.hasPrimaryButtonLabel,issue:I.MISSING_FOOTER_OR_PRIMARY},{condition:t=>t.position==="responsive"&&!t.hasMainContent,issue:I.RESPONSIVE_NEEDS_MAIN_CONTENT},{condition:t=>t.position==="modal"&&t.hasMainContent,issue:I.MODAL_MUST_NOT_HAVE_MAIN_CONTENT}];function Te(t){var n;return(n=qe.find(({condition:a})=>a(t)))==null?void 0:n.issue}function Pe(t,n){return!t&&!!n}function Se(t,n){return!t&&!!n}const _e=(t,n,a=0)=>t?`translateX(-${n+a}px)`:"none",Me="_drawer_1nljj_1",c={"drawer-responsive-container":"_drawer-responsive-container_1nljj_1",drawer:Me,"drawer-content":"_drawer-content_1nljj_44","drawer-toggle":"_drawer-toggle_1nljj_52","drawer-footer":"_drawer-footer_1nljj_61","drawer-header-content":"_drawer-header-content_1nljj_68"},Ae=4,$=({isCollapsible:t,iconToggleCloseContainerRef:n,isOpen:a,isAnimating:r,handleOnClickToggle:i,shouldDisplayDefaultHeader:s,id:p,title:f,icon:g,iconAppearance:x,onClose:v,isClosable:C,header:h,drawerLeftPosition:y})=>e.jsxs(e.Fragment,{children:[t&&e.jsx(P,{ref:n,className:c["drawer-toggle"],style:{transition:"none",transform:_e(r,y,Ae)},name:a?"right-panel-close":"right-panel-open",size:"l",variant:"primary",onClick:i,"aria-label":`Close drawer ${p}`}),s?e.jsx(Re,{id:p,title:f,icon:g,iconAppearance:x,onClose:v,isClosable:C}):e.jsx(e.Fragment,{children:h})]}),W=({content:t,fixedHeader:n})=>e.jsx("div",{className:c["drawer-content"],"data-fixed-header":n,tabIndex:-1,children:t}),K=({fixedHeader:t,id:n,title:a,icon:r,iconAppearance:i,isCollapsible:s,iconToggleCloseContainerRef:p,isOpen:f,isAnimating:g,handleOnClickToggle:x,shouldDisplayDefaultHeader:v,onClose:C,isClosable:h,header:y,drawerLeftPosition:b,content:w})=>e.jsx(e.Fragment,{children:t?e.jsxs(e.Fragment,{children:[e.jsx($,{id:n,title:a,icon:r,iconAppearance:i,isCollapsible:s,iconToggleCloseContainerRef:p,isOpen:f,isAnimating:g,handleOnClickToggle:x,shouldDisplayDefaultHeader:!!v,onClose:C,isClosable:h,header:y,drawerLeftPosition:b}),e.jsx(W,{content:w,fixedHeader:t})]}):e.jsxs("div",{className:c["drawer-header-content"],children:[e.jsx($,{id:n,title:a,icon:r,iconAppearance:i,isCollapsible:s,iconToggleCloseContainerRef:p,isOpen:f,isAnimating:g,handleOnClickToggle:x,shouldDisplayDefaultHeader:!!v,onClose:C,isClosable:h,header:y,drawerLeftPosition:b}),e.jsx(W,{content:w})]})}),X=({fixedHeader:t,shouldDisplayDefaultFooter:n,primaryButtonLabel:a,secondaryButtonLabel:r,footer:i,onClickPrimaryButton:s,onClickSecondaryButton:p})=>e.jsx("div",{className:c["drawer-footer"],"data-fixed-header":t,children:n?e.jsx(Ce,{primaryButton:e.jsx(O,{label:a,variant:"primary",onClick:s}),secondaryButton:r?e.jsx(O,{label:r,variant:"secondary",onClick:p}):void 0}):i&&e.jsx(e.Fragment,{children:i})}),E=({id:t,title:n,icon:a,iconAppearance:r,isOpen:i,onClose:s,onClickToggle:p,closeOnOverlayClick:f=!1,primaryButtonLabel:g,secondaryButtonLabel:x,isCollapsible:v=!1,content:C,header:h,footer:y,position:b,width:w,children:A,fixedHeader:N,closeOnEscape:pe=!1,isClosable:ge=!0,onClickPrimaryButton:ve,onClickSecondaryButton:he,...H})=>{var G;const{shouldRender:F,isAnimating:l}=Oe(i,De),B=R.useRef(null),S=R.useRef(null),_=R.useRef(null),U=((G=B.current)==null?void 0:G.clientWidth)||0;Be(f&&b==="modal"?s:()=>{},B.current),ke(pe?s:()=>{}),Ee(B.current,F);const ye=Pe(h,n),be=Se(y,g),V=Te({hasCustomHeader:h!==void 0,hasTitle:!!n,hasCustomFooter:y!==void 0,hasPrimaryButtonLabel:!!g,position:b,hasMainContent:!!A});if(V)return console.warn(V),null;const L=(we=0)=>l?`translateX(-${U+we}px)`:"none",M=()=>{i&&S.current&&S.current.focus(),!i&&_.current&&_.current.focus(),p()},z={fixedHeader:N,id:t,title:n,icon:a,iconAppearance:r,isCollapsible:v,iconToggleCloseContainerRef:_,isOpen:i,isAnimating:l,handleOnClickToggle:M,shouldDisplayDefaultHeader:!!ye,onClose:s,isClosable:ge,header:h,drawerLeftPosition:U,content:C},Q={fixedHeader:N,shouldDisplayDefaultFooter:!!be,primaryButtonLabel:g,secondaryButtonLabel:x,footer:y,onClickPrimaryButton:ve,onClickSecondaryButton:he};return e.jsx(e.Fragment,{children:b==="responsive"?e.jsx(e.Fragment,{children:e.jsxs("div",{className:c["drawer-responsive-container"],children:[v&&e.jsx(P,{className:c["drawer-toggle"],style:{position:"absolute",top:24,right:4,transition:"transform 240ms ease-out",opacity:l?0:1,transform:L(je)},name:"right-panel-open",size:"l",variant:"primary",onClick:M,"aria-label":`Close drawer ${t}`}),e.jsx(Ne,{orientation:"vertical",style:{position:"absolute",right:"0px",transition:"transform 240ms ease-out",visibility:l?"visible":"hidden",transform:L()}}),e.jsxs("div",{className:c.drawer,ref:B,"data-open":l,role:"region","aria-labelledby":`${t}-modal-title`,"data-position":b,"data-fixed-header":N,style:{width:w,transform:l?"none":`translateX(${w||"100%"})`,visibility:l?"visible":"hidden"},...H,children:[e.jsx(K,{...z}),e.jsx(X,{...Q})]}),e.jsx("div",{className:c["drawer-children"],"data-open":l,style:{height:"100%",transition:"margin-right 240ms ease-out",marginRight:l?w:0,maxHeight:l?"100vh":void 0,overflowY:l?"auto":void 0},children:A})]})}):e.jsxs(e.Fragment,{children:[v&&e.jsx(P,{ref:S,className:c["drawer-toggle"],style:{position:"absolute",top:24,right:4,opacity:l?0:1},name:"right-panel-open",size:"l",variant:"primary",onClick:M,"aria-label":`Close drawer ${t}`}),F&&e.jsxs(Ie,{freezeNavigation:!0,children:[e.jsx(xe,{isAnimating:l}),e.jsxs("div",{ref:B,className:c.drawer,"data-open":l,"data-fixed-header":N,role:"dialog","aria-modal":"true","aria-labelledby":`${t}-modal-title`,style:{width:w},...H,children:[e.jsx(K,{...z}),e.jsx(X,{...Q})]})]})]})})};E.__docgenInfo={description:"",methods:[],displayName:"Drawer",props:{header:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},footer:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},content:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},children:{required:!1,tsType:{name:"union",raw:"React.ReactNode | React.ReactNode[]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"Array",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}],raw:"React.ReactNode[]"}]},description:""},width:{required:!1,tsType:{name:"string"},description:""},closeOnOverlayClick:{defaultValue:{value:"false",computed:!1},required:!1},isCollapsible:{defaultValue:{value:"false",computed:!1},required:!1},closeOnEscape:{defaultValue:{value:"false",computed:!1},required:!1},isClosable:{defaultValue:{value:"true",computed:!1},required:!1}},composes:["coreDrawerProps","Omit"]};const lt={title:"Composants/Drawer/Drawer",component:E,tags:["autodocs"],argTypes:{id:{control:"text"},title:{control:"text"},icon:{control:"text"},iconAppearance:{control:"select",options:["outlined","filled"]},closeOnOverlayClick:{control:"boolean"},closeOnEscape:{control:"boolean"},primaryButtonLabel:{control:"text"},secondaryButtonLabel:{control:"text"},isCollapsible:{control:"boolean"},position:{control:"select",options:["modal","responsive"]},fixedHeader:{control:"boolean"},onClickPrimaryButton:{action:"primary click",control:!1},onClickSecondaryButton:{action:"secondary click",control:!1}}},m={args:{isOpen:!1,onClose(){console.log("Drawer closed")},id:"example-drawer",title:"Example Drawer",icon:"settings",iconAppearance:"outlined",primaryButtonLabel:"Confirm",secondaryButtonLabel:"Cancel",isCollapsible:!1,position:"modal",fixedHeader:!0,width:"400px",isClosable:!0,onClickToggle(){console.log("Toggle drawer")},onClickPrimaryButton:Y(),onClickSecondaryButton:Y(),content:e.jsx("span",{style:{fontFamily:"arial",fontSize:"14px",lineHeight:"20px",color:"var(--content-primary)"},children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis urna lacus. Praesent tempor nisl non arcu molestie gravida. Nam nec tincidunt sapien. Vestibulum a malesuada nisl. Maecenas nec magna nisi. Etiam tempus massa lobortis massa blandit ultricies. Ut in odio ex. Quisque a feugiat tellus. Proin vehicula risus non magna hendrerit mollis. Ut efficitur maximus sagittis. Integer eget est eget metus imperdiet lobortis. Cras scelerisque pharetra purus consectetur sollicitudin. Ut rhoncus, ipsum porta tempus pharetra, quam massa maximus sem, ac tempus ipsum sapien ac nisl. Mauris in neque vitae metus congue varius. Proin porta elementum bibendum. Vivamus venenatis sem metus, eu pulvinar tellus varius eu. Quisque vel condimentum nisl. Quisque maximus convallis elit ut vulputate. Integer eget laoreet velit. Donec viverra ac justo ut gravida. Nunc viverra tristique enim sit amet blandit. Curabitur odio nunc, ultricies euismod tortor id, ornare tincidunt leo. Ut at porta risus, ac condimentum nisi. Morbi ac nunc eu metus vehicula lacinia a at est. Praesent quis justo eu mauris finibus porta placerat ut metus. Sed vestibulum pretium dui id ultrices. Integer vulputate turpis sed turpis suscipit sagittis sed sed odio. Vestibulum eget eleifend eros, ut lobortis velit. Ut ac massa sed velit ullamcorper posuere. Sed a auctor eros. Maecenas ligula nunc, consectetur eu nulla vitae, aliquet molestie nibh. Vivamus eu ultricies ex. Integer sodales tempor nisi, non maximus velit hendrerit eu. Proin pretium sagittis odio sit amet tincidunt. Suspendisse at risus pellentesque, bibendum magna eget, congue mi. Morbi odio enim, pulvinar vitae purus sit amet, dapibus porttitor quam. Donec maximus lectus ac felis lobortis pulvinar. Maecenas vel blandit odio. Nulla volutpat, nisi eget elementum lobortis, enim mi ornare sapien, at tempor tortor nisl id mi. Curabitur et commodo dui. Aenean a viverra dui. Praesent ac nisi molestie, posuere nisl vitae, consequat erat. Proin et iaculis mi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elit metus, maximus sit amet laoreet at, hendrerit eu ipsum. Mauris vulputate et leo sed convallis. Sed id eros nulla. Praesent ex tellus, pulvinar ac ornare vitae, dapibus feugiat mauris. Sed leo mauris, tempus et interdum sit amet, luctus sed ligula."})},render:t=>{const[n,a]=R.useState(t.isOpen),r=()=>{a(s=>!s)},i=()=>{var s;(s=t.onClickPrimaryButton)==null||s.call(t),a(!1)};return e.jsxs(e.Fragment,{children:[e.jsx(O,{label:"Open drawer",onClick:()=>a(!0)}),e.jsx(E,{...t,isOpen:n,onClose:()=>a(!1),onClickToggle:r,onClickPrimaryButton:i})]})},play:async({canvasElement:t,args:n})=>{const r=await u(t).getByRole("button",{name:"Open drawer"});await d.click(r);const i=u(document.body).getByRole("dialog");o(i).toBeInTheDocument(),await d.click(u(i).getByRole("button",{name:"Cancel"})),o(n.onClickSecondaryButton).toHaveBeenCalled(),o(i).toBeInTheDocument(),await d.click(u(i).getByRole("button",{name:"Confirm"})),o(n.onClickPrimaryButton).toHaveBeenCalled(),await k(()=>{o(u(document.body).queryByRole("dialog")).not.toBeInTheDocument()})}},D={args:{...m.args,id:"responsive-drawer",title:"Responsive Drawer",position:"responsive",icon:void 0,isClosable:!0},render:t=>{const[n,a]=R.useState(t.isOpen),r=()=>{a(s=>!s)},i=()=>{var s;(s=t.onClickPrimaryButton)==null||s.call(t),a(!1)};return e.jsx("div",{style:{border:"1px solid #ccc",width:"600px",height:"500px"},children:e.jsx(E,{...t,isOpen:n,onClose:()=>a(!1),onClickToggle:r,onClickPrimaryButton:i,content:e.jsx("span",{style:{fontFamily:"arial",fontSize:"14px",lineHeight:"20px",color:"var(--content-primary)"},children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis urna lacus. Praesent tempor nisl non arcu molestie gravida. Nam nec tincidunt sapien. Vestibulum a malesuada nisl. Maecenas nec magna nisi. Etiam tempus massa lobortis massa blandit ultricies. Ut in odio ex. Quisque a feugiat tellus. Proin vehicula risus non magna hendrerit mollis. Ut efficitur maximus sagittis. Integer eget est eget metus imperdiet lobortis. Cras scelerisque pharetra purus consectetur sollicitudin. Ut rhoncus, ipsum porta tempus pharetra, quam massa maximus sem, ac tempus ipsum sapien ac nisl. Mauris in neque vitae metus congue varius. Proin porta elementum bibendum. Vivamus venenatis sem metus, eu pulvinar tellus varius eu. Quisque vel condimentum nisl. Quisque maximus convallis elit ut vulputate. Integer eget laoreet velit. Donec viverra ac justo ut gravida. Nunc viverra tristique enim sit amet blandit. Curabitur odio nunc, ultricies euismod tortor id, ornare tincidunt leo. Ut at porta risus, ac condimentum nisi. Morbi ac nunc eu metus vehicula lacinia a at est. Praesent quis justo eu mauris finibus porta placerat ut metus. Sed vestibulum pretium dui id ultrices. Integer vulputate turpis sed turpis suscipit sagittis sed sed odio. Vestibulum eget eleifend eros, ut lobortis velit. Ut ac massa sed velit ullamcorper posuere. Sed a auctor eros. Maecenas ligula nunc, consectetur eu nulla vitae, aliquet molestie nibh. Vivamus eu ultricies ex. Integer sodales tempor nisi, non maximus velit hendrerit eu. Proin pretium sagittis odio sit amet tincidunt."}),width:"400px",children:e.jsxs("div",{style:{height:"100%",display:"flex",flexDirection:"column",gap:"16px",padding:"16px"},children:[e.jsx(O,{label:"Open drawer",onClick:()=>a(!0)}),e.jsx("span",{style:{fontFamily:"arial",fontSize:"14px",lineHeight:"20px",color:"var(--content-primary)"},children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis urna lacus. Praesent tempor nisl non arcu molestie gravida. Nam nec tincidunt sapien. Vestibulum a malesuada nisl. Maecenas nec magna nisi. Etiam tempus massa lobortis massa blandit ultricies. Ut in odio ex. Quisque a feugiat tellus. Proin vehicula risus non magna hendrerit mollis. Ut efficitur maximus sagittis. Integer eget est eget metus imperdiet lobortis. Cras scelerisque pharetra purus consectetur sollicitudin. Ut rhoncus, ipsum porta tempus pharetra, quam massa maximus sem, ac tempus ipsum sapien ac nisl. Mauris in neque vitae metus congue varius. Proin porta elementum bibendum. eros. Nam nec tincidunt sapien. Vestibulum a malesuada nisl. Maecenas nec magna nisi. Etiam tempus massa lobortis massa blandit ultricies. Ut in odio ex. Quisque a feugiat tellus. Proin vehicula risus non magna hendrerit mollis."})]})})})},play:async({canvasElement:t,args:n})=>{const a=u(t),r=await a.getByRole("button",{name:"Open drawer"});await d.click(r);const i=await k(()=>{const s=a.getByRole("region",{name:/Responsive Drawer/i});return o(s).toHaveAttribute("data-position","responsive"),o(s).toHaveAttribute("data-open"),s});await d.click(u(i).getByRole("button",{name:"Cancel"})),o(n.onClickSecondaryButton).toHaveBeenCalled(),o(i).toHaveAttribute("data-open"),await d.click(u(i).getByRole("button",{name:"Confirm"})),o(n.onClickPrimaryButton).toHaveBeenCalled(),await k(()=>{o(i).not.toHaveAttribute("data-open")})}},j={args:{...m.args,id:"drawer-close-on-escape",title:"Close on Escape",closeOnEscape:!0,position:"modal"},render:m.render,parameters:{docs:{description:{story:"Modal drawer with **closeOnEscape** enabled (spec: close on Esc). Press Escape to dismiss without using the header close control."}}},play:async({canvasElement:t})=>{const n=u(t);await d.click(n.getByRole("button",{name:"Open drawer"}));const a=u(document.body).getByRole("dialog");o(a).toBeInTheDocument(),await d.keyboard(fe),await k(()=>{o(u(document.body).queryByRole("dialog")).not.toBeInTheDocument()})}},q={tags:["skip-ci"],args:{...m.args,id:"drawer-close-on-overlay-click",title:"Close on overlay click",closeOnOverlayClick:!0,position:"modal"},render:m.render,parameters:{docs:{description:{story:"Modal drawer with **closeOnOverlayClick** enabled. Clicking the backdrop (outside the panel) dismisses the drawer. Only applies when **position** is `modal`."}}},play:async({canvasElement:t})=>{const n=u(t);await d.click(n.getByRole("button",{name:"Open drawer"}));const r=u(document.body).getByRole("dialog").previousElementSibling;o(r).not.toBeNull(),await d.click(r),await k(()=>{o(u(document.body).queryByRole("dialog")).not.toBeInTheDocument()})}},T={args:{...m.args,closeOnEscape:!0,id:"custom-header-footer-drawer"},render:t=>{const[n,a]=R.useState(t.isOpen),r=()=>{a(i=>!i)};return e.jsxs(e.Fragment,{children:[e.jsx(O,{label:"Open drawer",onClick:()=>a(!0)}),e.jsx(E,{...t,isOpen:n,onClose:()=>a(!1),onClickToggle:r,header:e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",gap:"8px",width:"100%"},children:[e.jsx("span",{style:{fontSize:"16px",fontWeight:"bold",fontFamily:"arial",color:"var(--content-primary)"},children:"Custom Header"}),e.jsx(P,{name:"close",size:"m",onClick:()=>a(!1),"aria-label":"Close drawer"})]}),footer:e.jsx("div",{style:{display:"flex",justifyContent:"flex-end",gap:"8px",boxSizing:"border-box",width:"100%"},children:e.jsx(O,{label:"Custom Action",variant:"primary"})})})]})}};var J,Z,ee;m.parameters={...m.parameters,docs:{...(J=m.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
    isOpen: false,
    onClose() {
