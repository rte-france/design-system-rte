...
export const RegularIcons = {
  ...
  "circuit-capacitor": "circuit_capacitor",
  "circuit-cell": "circuit_cell",
  "circuit-ground": "circuit_ground",
  "circuit-inductor": "circuit_inductor",
  close: "close",
  company: "company",
  compare: "compare",
  "copy-all": "copy_all",
...
export const TogglableIcons = {
  ...
  "circuit-amperemetre": ["circuit_amperemetre_outlined", "circuit_amperemetre_filled"],
  "circuit-bulb": ["circuit_bulb_outlined", "circuit_bulb_filled"],
  "circuit-generator": ["circuit_generator_outlined", "circuit_generator_filled"],
  "circuit-motor": ["circuit_motor_outlined", "circuit_motor_filled"],
  "circuit-voltmetre": ["circuit_voltmetre_outlined", "circuit_voltmetre_filled"],
  ...
  "energy-savings-leaf": ["energy_savings_leaf_outlined", "energy_savings_leaf_filled"],
  eraser: ["eraser_outlined", "eraser_filled"],
  error: ["error_outlined", "error_filled"],
  "event-next": ["event_next_outlined", "event_next_filled"],
  "event-repeat": ["event_repeat_outlined", "event_repeat_filled"],
  ...
  journal: ["journal_outlined", "journal_filled"],
  ...
  "linked-services": ["linked_services_outlined", "linked_services_filled"],
  "list-alt": ["list_alt_outlined", "list_alt_filled"],
  "location-add": ["location_add_outlined", "location_add_filled"],
  ...
  version: ["version_outlined", "version_filled"],
