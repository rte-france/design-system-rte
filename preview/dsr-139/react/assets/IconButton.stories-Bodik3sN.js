import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{T as _,a as N}from"./keyboard-test.constants-By8W48aj.js";import{f as F,w as g,u,e as o}from"./index-DCXJbAaW.js";import{R as K,T as D}from"./Icon-DjEid3Hw.js";import{I as s}from"./IconButton-BoUdRPMh.js";import"./index-yBjzXJbu.js";import"./keyboard.constants-BverKK8B.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./Badge-yqZBktoR.js";import"./index-DSdvzt-y.js";const B=Object.keys(K),y=Object.keys(D),M={title:"IconButton",component:s,tags:["autodocs"],argTypes:{name:{control:"select",options:[...B,...y].sort((n,t)=>n.localeCompare(t)),description:"Nom de l’icône à afficher",defaultValue:"check"},variant:{control:"select",options:["primary","secondary","text","transparent","danger","neutral","inverse"]},appearance:{control:"select",options:["outlined","filled"],description:"Apparence de l’icône (pour les icônes togglables)",defaultValue:"outlined"},size:{control:"select",options:["s","m","l"]},compactSpacing:{control:"boolean",description:"Utiliser un espacement compact"},disabled:{control:"boolean"},badgeContent:{control:"select",options:["number","icon","empty"],description:"Type de contenu du badge"},badgeIcon:{control:"select",options:[...B,...y].sort((n,t)=>n.localeCompare(t)),description:"Nom de l’icône à afficher sur le badge",defaultValue:"check"},badgeCount:{control:"number",description:"Nombre à afficher dans le badge"},badgeType:{control:"select",options:["brand","neutral","indicator"],description:"Type de badge"}}},m=F(),c={args:{name:"settings",size:"m",appearance:"outlined",disabled:!1,compactSpacing:!1,"aria-label":"icon button aria label",onClick:m},render:n=>e.jsx(s,{...n}),play:async({canvasElement:n})=>{const a=g(n).getByRole("button");await u.click(a),o(m).toHaveBeenCalled(),a.blur()}},i={args:{...c.args},render:n=>e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(s,{...n,size:"s","data-testid":"small-icon-button"}),e.jsx(s,{...n,"data-testid":"medium-icon-button"}),e.jsx(s,{...n,size:"l","data-testid":"large-icon-button"})]}),play:async({canvasElement:n})=>{const t=g(n),a=t.getByTestId("small-icon-button"),p=t.getByTestId("medium-icon-button"),b=t.getByTestId("large-icon-button");o(a.clientHeight).toBe(24),o(p.clientHeight).toBe(32),o(b.clientHeight).toBe(40)}},r={args:{...c.args,compactSpacing:!0},render:n=>e.jsxs("div",{style:{display:"flex",gap:8},children:[e.jsx(s,{...n,size:"s","data-testid":"small-icon-button"}),e.jsx(s,{...n,"data-testid":"medium-icon-button"}),e.jsx(s,{...n,size:"l","data-testid":"large-icon-button"})]}),play:async({canvasElement:n})=>{const t=g(n),a=t.getByTestId("small-icon-button"),p=t.getByTestId("medium-icon-button"),b=t.getByTestId("large-icon-button");o(a.clientHeight).toBe(16),o(p.clientHeight).toBe(20),o(b.clientHeight).toBe(24)}},l={args:{name:"settings",size:"m",appearance:"outlined",disabled:!1,compactSpacing:!1,"aria-label":"icon button aria label",onClick:m,badgeContent:"number",badgeCount:1,badgeType:"brand"},render:n=>e.jsx(s,{...n})},d={args:{...c.args},play:async({canvasElement:n})=>{const a=g(n).getByRole("button");await u.tab(),o(a).toHaveFocus(),await u.keyboard(_),await u.keyboard(N),o(m).toHaveBeenCalledTimes(2),a.blur()}};var I,v,f;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    name: "settings",
    size: "m",
    appearance: "outlined",
...
}`,...(R=(w=d.parameters)==null?void 0:w.docs)==null?void 0:R.source}}};const Q=["Default","Sizing","CompactSizing","WithBadge","KeyboardInteraction"];export{r as CompactSizing,c as Default,d as KeyboardInteraction,i as Sizing,l as WithBadge,Q as __namedExportsOrder,M as default};
