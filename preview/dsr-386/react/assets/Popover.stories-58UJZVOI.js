import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{T as we,d as Ce}from"./keyboard-test.constants-C9whQEGR.js";import{userEvent as p,within as B,waitFor as j,expect as v}from"./index-DajN9u-m.js";import{f as Be}from"./testing.utils-C0VuMG32.js";import{g as Ee,b as xe,a as Te}from"./auto-placement-C6RxYMtA.js";import{E as Pe}from"./keyboard.constants-ep-ZHn_7.js";import{r as t}from"./index-G8LIXM5I.js";import{u as _e}from"./useAnimatedMount-_zPBpYOt.js";import{b as Ae,u as Re,a as Se}from"./useKeydownEscape-B9tjvDNB.js";import{B as O}from"./Button-B_03pXGd.js";import{O as Le}from"./Overlay-CtOPxSY4.js";import{c as I}from"./index-DSdvzt-y.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./dom.constants-pEgPeCLJ.js";import"./common-button.constants-eNlmcvUj.js";import"./Badge-ySgcnoLk.js";import"./Icon-DjEid3Hw.js";import"./index-B7EolvnA.js";import"./index-BLHw34Di.js";const V=8,k=20,Ne=r=>{t.useEffect(()=>(window.addEventListener("scroll",r,!0),()=>{window.removeEventListener("scroll",r,!0)}),[r])},je="_popoverTrigger_120ra_29",Oe="_popover_120ra_29",Ie="_popoverInner_120ra_53",Ve="_popoverContentContainer_120ra_61",ke="_popoverTitle_120ra_68",qe="_popoverContent_120ra_61",Fe="_popoverButtonContainer_120ra_92",i={popoverTrigger:je,popover:Oe,popoverInner:Ie,popoverContentContainer:Ve,popoverTitle:ke,popoverContent:qe,popoverButtonContainer:Fe},Z=t.forwardRef(({children:r,position:n="auto",alignment:c,content:C,arrow:f=!0,title:E,primaryButtonLabel:ee,secondaryButtonLabel:x,className:te="",triggerStyles:oe,closeOnClickOutside:T=!0,closeOnEscape:P=!0,onClickPrimaryButton:_,onClickSecondaryButton:A,...re},d)=>{const l=t.useRef(null),[a,ne]=t.useState(null),[ae,se]=t.useState(n),[ie,ce]=t.useState(c),[R,le]=t.useState({top:0,left:0}),[s,u]=t.useState(!1),{shouldRender:S,isAnimating:ue}=_e(s,150),[pe,L]=t.useState(!1),m=t.useCallback(()=>{if(!l.current||!a)return;const o=n==="auto"?Ee(l.current,a,"top",f?k:V):n,N=c||xe(l.current,a,o),ge=Te(o,l.current,a,f?k:V,N);ce(N),le(ge),se(o)},[n,f,a,c]),de=t.useCallback(()=>{T&&u(!1)},[T]),me=t.useCallback(()=>{P&&u(!1)},[P]);Ae(a,S),Re(de,l.current,a),Se(me),Ne(m);const ve=t.useCallback(o=>{ne(o),typeof d=="function"?d(o):d&&(d.current=o),o&&s&&requestAnimationFrame(()=>{requestAnimationFrame(()=>{m()})})},[d,s,m]);t.useEffect(()=>{s&&a?(m(),L(!0)):L(!1)},[s,a,m]);const fe=o=>{o.key===Pe&&(o.preventDefault(),s||u(!0))},he=o=>{s||(o.preventDefault(),u(!0))},be=()=>{A&&A(),u(!1)},ye=()=>{_&&_(),u(!1)};return e.jsxs("div",{ref:l,className:I(i.popoverTrigger),onClick:he,onKeyDown:fe,style:oe,children:[r,S&&e.jsx(Le,{children:e.jsx("div",{ref:ve,className:I(i.popover,te),role:"dialog","aria-modal":"true","data-arrow":f,"data-position":ae,"data-alignment":ie,"data-open":pe&&ue||void 0,style:{top:`${R.top}px`,left:`${R.left}px`},...re,children:e.jsxs("div",{className:i.popoverInner,children:[e.jsxs("div",{className:i.popoverContentContainer,children:[E&&e.jsx("div",{className:i.popoverTitle,children:E}),e.jsx("div",{className:i.popoverContent,children:C})]}),e.jsxs("div",{className:i.popoverButtonContainer,children:[x&&e.jsx(O,{className:"popoverButton",onClick:be,label:x,variant:"secondary"}),e.jsx(O,{className:"popoverButton",onClick:ye,label:ee,variant:"primary"})]})]})})})]})});Z.__docgenInfo={description:"",methods:[],displayName:"Popover",props:{content:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},triggerStyles:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""},position:{defaultValue:{value:'"auto"',computed:!1},required:!1},arrow:{defaultValue:{value:"true",computed:!1},required:!1},className:{defaultValue:{value:'""',computed:!1},required:!1},closeOnClickOutside:{defaultValue:{value:"true",computed:!1},required:!1},closeOnEscape:{defaultValue:{value:"true",computed:!1},required:!1}},composes:["CorePopoverProps","Omit"]};const st={title:"Composants/Popover",component:Z,decorators:[r=>e.jsx("div",{style:{height:"400px",width:"80%",padding:"100px",display:"flex",justifyContent:"center",alignItems:"center"},children:e.jsx(r,{})})],tags:["autodocs"],argTypes:{position:{control:"select",options:["auto","top","bottom","left","right"],description:"Position of the popover relative to trigger",defaultValue:"auto"},alignment:{control:"select",options:["start","center","end"],description:"Alignment of the popover",defaultValue:"start"},arrow:{control:"boolean",description:"Whether to show the arrow",defaultValue:!0},title:{control:"text",description:"Title of the popover",defaultValue:"Popover Title"},content:{control:"text",description:"Content of the popover",defaultValue:"Popover content"},primaryButtonLabel:{control:"text",description:"Label for the primary button",defaultValue:"Close"},secondaryButtonLabel:{control:"text",description:"Label for the secondary button",defaultValue:"Cancel"},children:{table:{disable:!0}},triggerStyles:{table:{disable:!0}},className:{table:{disable:!0}}}},h={args:{position:"auto",arrow:!0,title:"Popover Title",content:"Le Popover est un composant de type superposition (overlay), qui apparaît au clic, au focus ou au survol d'un élément déclencheur (trigger). Il est utilisé pour afficher un contenu contextuel enrichi : aide, options, actions complémentaires…",primaryButtonLabel:"Close",secondaryButtonLabel:"Cancel",children:e.jsx("button",{children:"Open Popover"})}},b={args:{position:"bottom",alignment:"start",arrow:!0,title:"Confirm Action",content:"Are you sure you want to proceed with this action? This cannot be undone.",primaryButtonLabel:"Confirm",secondaryButtonLabel:"Cancel",children:e.jsx("button",{children:"Open Confirmation"})}},y={args:{position:"top",alignment:"center",arrow:!0,content:"This popover has no title, just content and a close button.",primaryButtonLabel:"Got it",children:e.jsx("button",{children:"Show Info"})}},g={args:{position:"right",alignment:"start",arrow:!1,title:"No Arrow",content:"This popover is displayed without an arrow pointer.",primaryButtonLabel:"Close",children:e.jsx("button",{children:"Open Without Arrow"})}},w={args:{position:"auto",arrow:!0,title:"Popover Title",content:"Le Popover est un composant de type superposition (overlay), qui apparaît au clic, au focus ou au survol d'un élément déclencheur (trigger). Il est utilisé pour afficher un contenu contextuel enrichi : aide, options, actions complémentaires…",primaryButtonLabel:"Close",secondaryButtonLabel:"Cancel",children:e.jsx("button",{children:"Open Popover"})},play:async({canvasElement:r})=>{Be(r),await p.tab(),await p.keyboard(we);const n=B(document.body).getByRole("dialog");await j(()=>v(n).toBeVisible()),await p.tab();const c=B(n).getByRole("button",{name:/close/i});v(c).toHaveFocus(),await p.tab();const C=B(n).getByRole("button",{name:/cancel/i});v(C).toHaveFocus(),await p.tab(),v(c).toHaveFocus(),await p.keyboard(Ce),await j(()=>v(n).not.toBeVisible())}};var q,F,K;h.parameters={...h.parameters,docs:{...(q=h.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    position: "auto",
    arrow: true,
    title: "Popover Title",
