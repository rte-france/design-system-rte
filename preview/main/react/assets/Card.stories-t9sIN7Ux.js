import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import"./timepicker.constants-CynrC_9x.js";import{w as de,e as s,u as pe,f as he}from"./index-4rjIhT2C.js";import{a as ge}from"./testing.utils-r13wRTL2.js";import{B as p}from"./Button-KJfdYR4G.js";import{S as E,E as A}from"./keyboard.constants-BverKK8B.js";import{l as ue}from"./log-handlers-DViU2c-X.js";import{r as g}from"./index-G8LIXM5I.js";import{u as xe}from"./useActiveKeyboard-DaOmFJe_.js";import"./index-yBjzXJbu.js";import"./common-button.constants-CJxonyEE.js";import"./Badge-DkJhvK8e.js";import"./Icon-DgLH6pPJ.js";import"./index-DJ8f9STe.js";import"./_commonjsHelpers-CqkleIqs.js";const ye="Clickable cards must have an accessible name via aria-label, aria-labelledby, or text content.",Z="480px",me="Clickable cards must have an accessible name via aria-label, aria-labelledby, or text content.",fe={width:{control:"text",description:"Width of the card (e.g. '480px', '50%'). Defaults to 480px."},cardType:{control:"select",options:["default","outlined"],description:"Type of card styling"},clickable:{control:"boolean",description:"Whether the card is clickable"},disabled:{control:"boolean",description:"Whether the card is disabled"}},be=[{label:"Extra Small",width:"240px"},{label:"Small",width:"360px"},{label:"Medium",width:"480px"},{label:"Large",width:"600px"},{label:"Extra Large",width:"720px"}],Ce=[{cardType:"default",title:"Default Card",description:"This card uses the default styling with elevation shadow."},{cardType:"outlined",title:"Outlined Card",description:"This card uses outlined styling with a border instead of shadow."}],d={width:Z,cardType:"default",clickable:!1,disabled:!1},j={...d,clickable:!0},ve={...d,clickable:!0,disabled:!0},ke="_card_z06hj_1",Se={card:ke},n=g.forwardRef(({width:a=Z,height:t="auto",cardType:o="default",clickable:i=!1,disabled:l=!1,children:ee,onClick:c,role:ae,"aria-label":k,"aria-labelledby":S,...te},h)=>{const T=g.useRef(null),[ne,re]=g.useState(!0);g.useLayoutEffect(()=>{var r,w;i&&!k&&!S&&!((w=(r=T.current)==null?void 0:r.textContent)!=null&&w.trim())&&(ue("Card",me),re(!1))},[k,S,i]);const ie=r=>{!l&&i&&(r.key===E||r.key===A)&&(r.preventDefault(),c==null||c())},le=()=>{!l&&i&&(c==null||c())},{onKeyDown:se,onKeyUp:oe,onBlur:ce}=xe({onKeyUp:ie},{interactiveKeyCodes:[E,A]});return ne?e.jsx("div",{ref:r=>{T.current=r,typeof h=="function"?h(r):h&&(h.current=r)},className:Se.card,style:{width:a,height:t},"data-card-type":o,"data-clickable":i,"data-disabled":l,"aria-disabled":l,tabIndex:i&&!l?0:-1,role:ae??(i?"button":void 0),"aria-label":k,"aria-labelledby":S,onClick:le,onKeyDown:se,onKeyUp:oe,onBlur:ce,...te,children:ee}):null});n.__docgenInfo={description:"",methods:[],displayName:"Card",props:{onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},width:{defaultValue:{value:'"480px"',computed:!1},required:!1},height:{defaultValue:{value:'"auto"',computed:!1},required:!1},cardType:{defaultValue:{value:'"default"',computed:!1},required:!1},clickable:{defaultValue:{value:"false",computed:!1},required:!1},disabled:{defaultValue:{value:"false",computed:!1},required:!1}},composes:["CardPropsCore","Omit"]};const Pe={title:"Composants/Card",component:n,tags:["autodocs"],argTypes:{...fe,onClick:{action:"clicked"}},args:{onClick:he()}},je=e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Card Title"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This is a sample card with some content. You can add any content you want here, including text, images, buttons, or other components."})]}),u={args:{...d,children:je}},x={args:d,render:a=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:be.map(t=>e.jsx(n,{...a,width:t.width,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 8px 0",fontSize:"16px",fontWeight:"600"},children:t.label}),e.jsx("p",{style:{margin:"0",color:"#666",fontSize:"14px"},children:t.width})]})},t.width))})},y={args:d,render:a=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:Ce.map(t=>e.jsx(n,{...a,cardType:t.cardType,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 8px 0",fontSize:"18px",fontWeight:"600"},children:t.title}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:t.description})]})},t.cardType))})},m={tags:["!autodocs"],args:j,render:a=>e.jsx(n,{...a,onClick:a.onClick,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Clickable Card"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This card is clickable. Click anywhere on the card to trigger an action."}),e.jsx("p",{style:{margin:"0",color:"#999",fontSize:"14px"},children:"Check the console or Actions panel to see the click event."})]})}),play:async({canvasElement:a,args:t})=>{const l=de(a).getByText("Clickable Card").closest("[data-clickable='true']");s(l).toBeInTheDocument(),await pe.click(l),s(t.onClick).toHaveBeenCalled()}},f={tags:["!autodocs"],args:{...j,children:void 0},beforeEach:ge(`[Card] ${ye}`),play:async({canvasElement:a})=>{s(a.querySelector("[data-clickable='true']")).not.toBeInTheDocument()}},b={args:ve,render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(n,{...a,cardType:"default",clickable:!0,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Disabled Default Card"}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:"This card is disabled and cannot be clicked."})]})}),e.jsx(n,{...a,cardType:"outlined",children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Disabled Outlined Card"}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:"This outlined card is also disabled."})]})})]}),play:async({canvasElement:a})=>{const t=a.querySelectorAll("[data-disabled='true']");s(t.length).toBeGreaterThan(0),t.forEach(o=>{s(o).toHaveAttribute("data-disabled","true"),s(o).toHaveAttribute("aria-disabled","true"),s(o).toHaveAttribute("tabindex","-1")})}},C={args:d,render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(n,{...a,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Primary Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with primary button variant"}),e.jsx(p,{variant:"primary",label:"Primary Action",onClick:()=>console.log("Primary clicked")})]})}),e.jsx(n,{...a,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Secondary Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with secondary button variant"}),e.jsx(p,{variant:"secondary",label:"Secondary Action",onClick:()=>console.log("Secondary clicked")})]})}),e.jsx(n,{...a,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Multiple Buttons"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with multiple button actions"}),e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx(p,{variant:"primary",label:"Save",onClick:()=>console.log("Save clicked")}),e.jsx(p,{variant:"neutral",label:"Cancel",onClick:()=>console.log("Cancel clicked")})]})]})})]})},v={args:j,render:a=>e.jsx(n,{...a,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Clickable Card with Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This card is clickable. Click anywhere on the card to trigger the card click event. The button inside will stop propagation, so clicking it won't trigger the card click."}),e.jsx(p,{variant:"primary",label:"Action Button",onClick:t=>{t.stopPropagation(),console.log("Button clicked inside card")}})]})})};var B,D,W;u.parameters={...u.parameters,docs:{...(B=u.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    ...defaultStoryArgs,
...
}`,...(L=(K=f.parameters)==null?void 0:K.docs)==null?void 0:L.source}}};var G,V,U;b.parameters={...b.parameters,docs:{...(G=b.parameters)==null?void 0:G.docs,source:{originalSource:`{
...
}`,...(U=(V=b.parameters)==null?void 0:V.docs)==null?void 0:U.source}}};var Y,$,F;C.parameters={...C.parameters,docs:{...(Y=C.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: defaultStoryArgs,
  render: args => <div style={{
    display: "flex",
    flexDirection: "column",
...
}`,...(F=($=C.parameters)==null?void 0:$.docs)==null?void 0:F.source}}};var J,Q,X;v.parameters={...v.parameters,docs:{...(J=v.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: clickableStoryArgs,
