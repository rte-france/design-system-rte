import{j as s}from"./jsx-runtime-Cf8x2fCZ.js";import{T as k,a as h}from"./keyboard-test.constants-C9whQEGR.js";import{fn as f,within as d,userEvent as l,expect as o}from"./index-DajN9u-m.js";import{R as C,T as S}from"./Icon-DjEid3Hw.js";import{B as i}from"./Button-cobwPeAi.js";import"./index-yBjzXJbu.js";import"./keyboard.constants-ep-ZHn_7.js";import"./common-button.constants-eNlmcvUj.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./Badge-Dn6YlCGY.js";import"./index-DSdvzt-y.js";const w=Object.keys(C),H=Object.keys(S),A={title:"Composants/Button",component:i,tags:["autodocs"],argTypes:{variant:{control:"select",options:["primary","secondary","text","transparent","danger","neutral","reverse"]},size:{control:"select",options:["s","m","l"]},iconPosition:{control:"select",options:["left","right"]},disabled:{control:"boolean"},badgeContent:{control:"select",options:["number","icon","empty"],description:"Type de contenu du badge"},badgeIcon:{control:"select",options:[...w,...H].sort((t,e)=>t.localeCompare(e)),description:"Nom de l’icône à afficher sur le badge",defaultValue:"check"},badgeCount:{control:"number",description:"Nombre à afficher dans le badge"},badgeType:{control:"select",options:["brand","neutral","indicator"],description:"Type de badge"}},args:{onClick:f()}},u=f(),a={args:{variant:"primary",label:"Button",onClick:u},play:async({canvasElement:t})=>{const n=d(t).getByRole("button");await l.click(n),o(u).toHaveBeenCalled(),n.blur()}},r={args:{...a.args},render:t=>s.jsxs("div",{style:{display:"flex",gap:8},children:[s.jsx(i,{...t,size:"s",label:"Small","data-testid":"small-button"}),s.jsx(i,{...t,label:"Medium","data-testid":"medium-button"}),s.jsx(i,{...t,size:"l",label:"Large","data-testid":"large-button"})]}),play:async({canvasElement:t})=>{const e=d(t),n=e.getByTestId("small-button"),x=e.getByTestId("medium-button"),I=e.getByTestId("large-button");o(n.clientHeight).toBe(24),o(x.clientHeight).toBe(32),o(I.clientHeight).toBe(40)}},c={args:{...a.args},play:async({canvasElement:t})=>{const n=d(t).getByRole("button");await l.tab(),o(n).toHaveFocus(),await l.keyboard(k),await l.keyboard(h),o(u).toHaveBeenCalledTimes(2),n.blur()}};var m,p,g;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    variant: "primary",
    label: "Button",
    onClick: mockFn
