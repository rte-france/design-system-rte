import{j as a}from"./jsx-runtime-Cf8x2fCZ.js";import{f as q,w as u,u as o,e as n}from"./index-DCXJbAaW.js";import{T as s}from"./Textarea-kNG9BS3s.js";import"./index-yBjzXJbu.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./RequiredIndicator-mBhPxlm2.js";import"./Icon-DjEid3Hw.js";import"./Link-DbCKFFRz.js";import"./index-DSdvzt-y.js";const G={title:"Composants/Textarea/Textarea",tags:["autodocs"],component:s,args:{disabled:!1},argTypes:{value:{control:"text"},label:{control:"text"},labelPosition:{control:"select",options:["top","side"],description:"Position of the label relative to the textarea"},disabled:{control:"boolean"},rows:{control:"number"},onChange:{action:"changed"},assistiveTextAppearance:{control:"select",options:["description","error","success","link"],description:"Appearance of the assistive text"},assistiveTextLink:{control:"text",description:"Link for the assistive text when appearance is 'link'"},required:{control:"boolean",description:"Whether the textarea is required"},showLabelRequirement:{control:"boolean",description:"Whether to show the requirement indicator in the label"},maxLength:{control:"number",description:"Maximum number of characters allowed in the textarea"},showCounter:{control:"boolean",description:"Whether to display the character count"},readOnly:{control:"boolean",description:"Whether the textarea is read-only"}}},m=q(),t={args:{id:"my-textarea",label:"Label",labelId:"LabelId",assistiveTextLabel:"Assistive text for the textarea",required:!1,showLabelRequirement:!1,onChange:m,readOnly:!1,rows:3},render:e=>a.jsx("div",{style:{width:"350px"},children:a.jsx(s,{...e})})},i={args:{...t.args,maxLength:10},render:e=>a.jsx("div",{style:{width:"350px"},children:a.jsx(s,{...e})}),play:async({canvasElement:e})=>{const r=u(e).getByRole("textbox");await o.type(r,"Hello World"),n(m).toHaveBeenCalledTimes(10),n(r).toHaveValue("Hello Worl")}},c={args:{...t.args,maxLength:100,assistiveTextLabel:"Error message",assistiveTextAppearance:"error"},render:e=>a.jsx("div",{style:{width:"350px"},children:a.jsx(s,{...e})})},d={args:{...t.args,readOnly:!0,value:"This is a read-only textarea."},render:e=>a.jsx("div",{style:{width:"350px"},children:a.jsx(s,{...e})}),play:async({canvasElement:e,args:l})=>{const v=u(e).getByRole("textbox");await o.tab(),n(v).toHaveFocus(),await o.type(v,"Hello World"),n(m).not.toHaveBeenCalled(),n(v).toHaveValue(l.value)}},x={args:{...t.args,disabled:!0},render:e=>a.jsx("div",{style:{width:"350px"},children:a.jsx(s,{...e})}),play:async({canvasElement:e})=>{const r=u(e).getByRole("textbox");await o.tab(),n(r).not.toHaveFocus()}},p={args:{...t.args},render:e=>a.jsx("div",{style:{width:"350px"},children:a.jsx(s,{...e})}),play:async({canvasElement:e})=>{const r=u(e).getByRole("textbox");await o.tab(),n(r).toHaveFocus(),r.blur()}};var g,h,y;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    id: "my-textarea",
    label: "Label",
    labelId: "LabelId",
...
}`,...(k=(D=p.parameters)==null?void 0:D.docs)==null?void 0:k.source}}};const J=["Default","CharacterCount","Error","ReadOnly","Disabled","KeyboardInteraction"];export{i as CharacterCount,t as Default,x as Disabled,c as Error,p as KeyboardInteraction,d as ReadOnly,J as __namedExportsOrder,G as default};
