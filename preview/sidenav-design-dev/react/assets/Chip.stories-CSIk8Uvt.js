import{j as s}from"./jsx-runtime-Cf8x2fCZ.js";import{T as u,a as N}from"./keyboard-test.constants-C3026ykJ.js";import{E as j}from"./keyboard.constants-Ci2qhLdf.js";import{f as K,w as b,u as t,e as i}from"./index-DaW6VCyr.js";import{r as E}from"./index-G8LIXM5I.js";import{B as D}from"./Button-B-hhLjRd.js";import{T as M}from"./TextInput-CuZLyrA_.js";import{C}from"./Chip-DRKMyBi_.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DSdvzt-y.js";import"./Icon-DjEid3Hw.js";import"./IconButton-CY-isvho.js";import"./Link-Ef06xDiJ.js";import"./useActiveKeyboard-DAXsdPh3.js";const te={title:"Chip",component:C,tags:["autodocs"],argTypes:{label:{control:"text",description:"Label of the chip",defaultValue:"Chip"},disabled:{control:"boolean"},compactSpacing:{control:"boolean",description:"Whether the chip should be compact"},type:{control:"select",options:["single","multi","input"],description:"Type of the chip",defaultValue:"single"}},args:{onClick:K()}},h={args:{id:"chip-1",label:"Label",selected:!1,disabled:!1,compactSpacing:!1}},g={args:{...h.args},render:o=>{var l;const[n,e]=E.useState(null),p=[{id:"all",label:"All"},{id:"option-1",label:"Option 1"},{id:"option-2",label:"Option 2"}],d=a=>{const r=a.currentTarget.id;e(r===n?null:r)};return s.jsxs(s.Fragment,{children:[s.jsx("div",{style:{display:"flex",gap:"10px"},role:"radiogroup",children:p.map(({id:a,label:r})=>s.jsx(C,{id:a,label:r,selected:n===a,onClick:d,type:"single",compactSpacing:o.compactSpacing,className:"chip"},a))}),s.jsxs("p",{style:{fontFamily:"Arial, sans-serif"},children:["Chip sélectionnée: ",((l=p.find(a=>a.id===n))==null?void 0:l.label)||"Aucune"]})]})},play:async({canvasElement:o})=>{const e=b(o).getAllByRole("radio");await t.click(e[0]),i(e[0]).toHaveAttribute("aria-checked","true"),await t.click(e[1]),i(e[1]).toHaveAttribute("aria-checked","true"),i(e[0]).toHaveAttribute("aria-checked","false"),await t.click(e[1]),await t.tab(),i(e[2]).toHaveFocus(),await t.keyboard(u),i(e[2]).toHaveAttribute("aria-checked","true"),await t.keyboard(N),i(e[2]).toHaveAttribute("aria-checked","false")}},y={args:{...h.args},render:o=>{const[n,e]=E.useState([]),p=[{id:"option-1",label:"Option 1"},{id:"option-2",label:"Option 2"},{id:"option-3",label:"Option 3"}],d=l=>{const a=l.currentTarget.id;e(r=>r.includes(a)?r.filter(c=>c!==a):[...r,a])};return s.jsxs(s.Fragment,{children:[s.jsx("div",{style:{display:"flex",gap:"10px"},role:"group",children:p.map(({id:l,label:a})=>s.jsx(C,{id:l,label:a,selected:n.includes(l),onClick:d,type:"multi",compactSpacing:o.compactSpacing},l))}),s.jsxs("p",{style:{fontFamily:"Arial, sans-serif"},children:["Chip(s) sélectionnée(s):"," ",p.filter(l=>n.includes(l.id)).map(l=>l.label).join(", ")]})]})},play:async({canvasElement:o})=>{const e=b(o).getAllByRole("checkbox");await t.click(e[0]),i(e[0]).toHaveAttribute("aria-checked","true"),await t.click(e[1]),i(e[1]).toHaveAttribute("aria-checked","true"),i(e[0]).toHaveAttribute("aria-checked","true"),await t.click(e[1]),i(e[1]).toHaveAttribute("aria-checked","false"),await t.tab(),i(e[2]).toHaveFocus(),await t.keyboard(u),i(e[2]).toHaveAttribute("aria-checked","true")}},m={args:{...h.args,type:"input"},render:()=>{const[o,n]=E.useState(""),[e,p]=E.useState([]),d=c=>{n(c)},l=c=>{c.key===j&&(c.preventDefault(),a())},a=()=>{o&&!e.includes(o)&&(p(c=>[...c,o]),n(""))},r=c=>{const v=c.currentTarget.value;p(k=>k.includes(v)?k.filter(V=>V!==v):k)};return s.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[s.jsxs("div",{style:{display:"flex",gap:"10px",alignItems:"end"},children:[s.jsx(M,{id:"input-add-chip",label:"Ajouter un chip",value:o,onChange:d,onKeyDown:l}),s.jsx(D,{label:"Ajouter",onClick:a})]}),e.length>0&&s.jsx("div",{style:{display:"flex",gap:"10px"},role:"listbox","aria-label":"Chips list",children:e.map((c,v)=>s.jsx(C,{id:`chip-${v}-${c}`,label:c,selected:!1,disabled:!1,type:"input",onClose:r},v+c))})]})},play:async({canvasElement:o})=>{const n=b(o),e=n.getByRole("textbox");await t.type(e,"New Chip"),await t.keyboard(u),await t.type(e,"Another Chip"),await t.keyboard(u);const p=n.getAllByRole("option");i(p).toHaveLength(2);const d=b(p[0]).getByRole("button");await t.click(d);const l=n.getAllByRole("option");i(l).toHaveLength(1),await t.type(e,"More Chip"),await t.keyboard(u);const a=n.getAllByRole("option");i(a).toHaveLength(2),a[0].focus(),await t.tab(),await t.keyboard(u),i(n.getAllByRole("option")).toHaveLength(1),await t.type(e,"Last Chip"),await t.keyboard(u),i(n.getAllByRole("option")).toHaveLength(2),n.getAllByRole("option")[1].focus(),await t.tab(),await t.keyboard(N),i(n.getAllByRole("option")).toHaveLength(1)}};var f,x,w;h.parameters={...h.parameters,docs:{...(f=h.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    id: "chip-1",
    label: "Label",
    selected: false,
