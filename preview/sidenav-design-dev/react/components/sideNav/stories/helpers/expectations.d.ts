...
declare function hasActiveClass(element: HTMLElement): boolean;
...
export { expectElementToHaveFocus, expectElementNotToHaveFocus, expectElementToBeSkipped, expectElementToBeAccessible, expectNavItemToBeActive, expectNavItemNotToBeActive, hasActiveClass, };
