import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{f as J,w as Q,e as m,u as X}from"./index-DCXJbAaW.js";import{B as l}from"./Button-BGjTm3Lt.js";import{S as v,E as C}from"./keyboard.constants-ep-ZHn_7.js";import{r as Z}from"./index-G8LIXM5I.js";import{u as $}from"./useActiveKeyboard-BPEscCvd.js";import"./index-yBjzXJbu.js";import"./index-DSdvzt-y.js";import"./_commonjsHelpers-CqkleIqs.js";const ee={size:{control:"select",options:["xs","s","m","l","xl"],description:"Size of the card"},cardType:{control:"select",options:["default","outlined"],description:"Type of card styling"},clickable:{control:"boolean",description:"Whether the card is clickable"},disabled:{control:"boolean",description:"Whether the card is disabled"}},ae=[{size:"xs",label:"Extra Small (xs)",width:"240px width"},{size:"s",label:"Small (s)",width:"360px width"},{size:"m",label:"Medium (m)",width:"480px width"},{size:"l",label:"Large (l)",width:"600px width"},{size:"xl",label:"Extra Large (xl)",width:"720px width"}],ne=[{cardType:"default",title:"Default Card",description:"This card uses the default styling with elevation shadow."},{cardType:"outlined",title:"Outlined Card",description:"This card uses outlined styling with a border instead of shadow."}],r={size:"m",cardType:"default",clickable:!1,disabled:!1},L={...r,clickable:!0},te={...r,clickable:!0,disabled:!0},ie={xs:240,s:360,m:480,l:600,xl:720},re="_card_2viu3_3",le={card:re},t=Z.forwardRef(({size:a="m",cardType:n="default",clickable:i=!1,disabled:u=!1,children:s,onClick:o,...N},R)=>{const Y=f=>{!u&&i&&(f.key===v||f.key===C)&&(f.preventDefault(),o==null||o())},{onKeyDown:G,onKeyUp:U,onBlur:F}=$({onKeyUp:Y},{interactiveKeyCodes:[v,C]});return e.jsx("div",{ref:R,className:le.card,style:{width:ie[a]},"data-card-type":n,"data-clickable":i,"data-disabled":u,tabIndex:i?0:-1,onClick:o,onKeyDown:G,onKeyUp:U,onBlur:F,...N,children:s})});t.__docgenInfo={description:"",methods:[],displayName:"Card",props:{onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},size:{defaultValue:{value:'"m"',computed:!1},required:!1},cardType:{defaultValue:{value:'"default"',computed:!1},required:!1},clickable:{defaultValue:{value:"false",computed:!1},required:!1},disabled:{defaultValue:{value:"false",computed:!1},required:!1}},composes:["CardPropsCore","Omit"]};const ue={title:"Composants/Card",component:t,tags:["autodocs"],argTypes:{...ee,onClick:{action:"clicked"}},args:{onClick:J()}},se=e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Card Title"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This is a sample card with some content. You can add any content you want here, including text, images, buttons, or other components."})]}),d={args:{...r,children:se}},c={args:r,render:a=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:ae.map(n=>e.jsx(t,{...a,size:n.size,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 8px 0",fontSize:"16px",fontWeight:"600"},children:n.label}),e.jsx("p",{style:{margin:"0",color:"#666",fontSize:"14px"},children:n.width})]})},n.size))})},p={args:r,render:a=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:ne.map(n=>e.jsx(t,{...a,cardType:n.cardType,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 8px 0",fontSize:"18px",fontWeight:"600"},children:n.title}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:n.description})]})},n.cardType))})},g={args:L,render:a=>e.jsx(t,{...a,onClick:a.onClick,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Clickable Card"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This card is clickable. Click anywhere on the card to trigger an action."}),e.jsx("p",{style:{margin:"0",color:"#999",fontSize:"14px"},children:"Check the console or Actions panel to see the click event."})]})}),play:async({canvasElement:a,args:n})=>{const s=Q(a).getByText("Clickable Card").closest("[data-clickable='true']");m(s).toBeInTheDocument(),await X.click(s),m(n.onClick).toHaveBeenCalled()}},h={args:te,render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(t,{...a,cardType:"default",children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Disabled Default Card"}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:"This card is disabled and cannot be clicked."})]})}),e.jsx(t,{...a,cardType:"outlined",children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Disabled Outlined Card"}),e.jsx("p",{style:{margin:"0",color:"#666",lineHeight:"1.5"},children:"This outlined card is also disabled."})]})})]}),play:async({canvasElement:a})=>{const n=a.querySelectorAll("[data-disabled='true']");m(n.length).toBeGreaterThan(0),n.forEach(i=>{m(i).toHaveAttribute("data-disabled","true")})}},x={args:r,render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(t,{...a,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Primary Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with primary button variant"}),e.jsx(l,{variant:"primary",label:"Primary Action",onClick:()=>console.log("Primary clicked")})]})}),e.jsx(t,{...a,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Secondary Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with secondary button variant"}),e.jsx(l,{variant:"secondary",label:"Secondary Action",onClick:()=>console.log("Secondary clicked")})]})}),e.jsx(t,{...a,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h3",{style:{margin:"0 0 12px 0",fontSize:"18px",fontWeight:"600"},children:"Multiple Buttons"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"Card with multiple button actions"}),e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx(l,{variant:"primary",label:"Save",onClick:()=>console.log("Save clicked")}),e.jsx(l,{variant:"neutral",label:"Cancel",onClick:()=>console.log("Cancel clicked")})]})]})})]})},y={args:L,render:a=>e.jsx(t,{...a,children:e.jsxs("div",{style:{padding:"16px"},children:[e.jsx("h2",{style:{margin:"0 0 12px 0",fontSize:"20px",fontWeight:"600"},children:"Clickable Card with Button"}),e.jsx("p",{style:{margin:"0 0 16px 0",color:"#666",lineHeight:"1.5"},children:"This card is clickable. Click anywhere on the card to trigger the card click event. The button inside will stop propagation, so clicking it won't trigger the card click."}),e.jsx(l,{variant:"primary",label:"Action Button",onClick:n=>{n.stopPropagation(),console.log("Button clicked inside card")}})]})})};var b,k,S;d.parameters={...d.parameters,docs:{...(b=d.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    ...defaultStoryArgs,
...
}`,...(V=(M=y.parameters)==null?void 0:M.docs)==null?void 0:V.source}}};const fe=["Default","Sizes","CardTypes","Clickable","Disabled","WithButtons","ClickableWithContent"];export{p as CardTypes,g as Clickable,y as ClickableWithContent,d as Default,h as Disabled,c as Sizes,x as WithButtons,fe as __namedExportsOrder,ue as default};
