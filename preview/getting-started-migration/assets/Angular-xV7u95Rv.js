import{j as e,M as i}from"./index-C19CG4es.js";import{useMDXComponents as r}from"./index-DL7Mpk60.js";/* empty css                   *//* empty css               */import"./iframe-MgchEdug.js";import"./index-B0WjJBI_.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-Dif16jpf.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";function t(n){const s={code:"code",strong:"strong",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Démarrage/Angular"}),`
...
`,e.jsxs("p",{children:[" Le ",e.jsx(s.strong,{children:"Design System RTE"})," est une bibliothèque de composants ",e.jsx(s.strong,{children:"Angular"})," qui permet d'unifier le comportement et l'apparence des interfaces utilisateur à travers les équipes de ",e.jsx(s.strong,{children:"RTE France"}),". "]}),`
`,e.jsxs("p",{children:[" Il est organisé en monorepo avec trois packages principaux. Le package ",e.jsx("code",{children:"@design-system-rte/core"})," contient les design tokens et interfaces partagées, tandis que ",e.jsx("code",{children:"@design-system-rte/angular"})," fournit les composants ",e.jsx(s.strong,{children:"Angular"})," spécifiques. Cette architecture permet une maintenance centralisée tout en offrant des implémentations optimisées pour chaque framework. "]}),`
`,e.jsx("h2",{id:"installation",style:{border:"none",fontFamily:"Nunito"},children:" Installation "}),`
`,e.jsxs("p",{children:[" Pour installer le design system dans votre projet ",e.jsx(s.strong,{children:"Angular"}),", exécutez la commande suivante : "]}),`
...
`,e.jsxs("p",{children:[" Ce guide suppose que vous avez déjà une application ",e.jsx(s.strong,{children:"Angular"})," existante. La version d'",e.jsx(s.strong,{children:"Angular"})," doit être ",e.jsx(s.strong,{children:"18"})," ou supérieure.",e.jsx("br",{}),"Le package utilise aussi les peer dependencies suivantes (qui devraient déjà être présentes dans votre projet) :"]}),`
...
`,e.jsxs("p",{children:[" Incluez le mixin ",e.jsx(s.strong,{children:"branding/theme"})," dans votre fichier ",e.jsx(s.code,{children:".scss"})," principal (généralement ",e.jsx(s.code,{children:"styles.scss"})," à la racine de votre projet). Cela créera une portée de style pour les composants. "]}),`
...
`,e.jsxs("p",{children:[" Pour utiliser le composant Icon (",e.jsx("code",{children:"rte-icon"}),"), vous devez copier les fichiers ",e.jsx(s.code,{children:".svg"})," depuis le package core vers votre application. "]}),`
...
`,e.jsxs("p",{children:[" Vous pouvez lire le reste de la documentation du composant ",e.jsx(s.strong,{children:"Button"})," (",e.jsx("code",{children:"rteButton"}),") sur le ",e.jsx("a",{href:"https://opensource.rte-france.com/design-system-rte/?path=/docs/angular_button--docs",children:"Storybook du composant"}),"."]}),`
...
`,e.jsxs("p",{children:[" Pour lire les changelogs de tous les packages, consultez le ",e.jsx("a",{href:"https://github.com/rte-france/design-system-rte/blob/main/CHANGELOG.md",children:"CHANGELOG principal"}),". "]})]})}function j(n={}){const{wrapper:s}={...r(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(t,{...n})}):t(n)}export{j as default};
