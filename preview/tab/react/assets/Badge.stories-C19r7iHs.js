import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{w as h,e as i,u as o,a as B}from"./index-DaW6VCyr.js";import{r as X}from"./index-G8LIXM5I.js";import{R as Y,T as Z}from"./Icon-DjEid3Hw.js";import{B as n}from"./Badge-BHtUYWmb.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-DSdvzt-y.js";const $=Object.keys(Y),ee=Object.keys(Z),pe={title:"Composants/Badge/Badge",component:n,tags:["autodocs"],argTypes:{badgeType:{control:"select",options:["brand","neutral","indicator"],description:"Type of badge",defaultValue:"brand"},size:{control:"select",options:["xs","s","m","l"],description:"Size of the badge",defaultValue:"M"},appearance:{control:"select",options:["text","icon","empty"],description:"Appearance of the badge",defaultValue:"text"},count:{control:"number",description:"Count to display when appearance is 'text'",defaultValue:1},icon:{control:"select",options:[...$,...ee].sort((a,t)=>a.localeCompare(t)),description:"Icon to display when appearance is 'icon'"}}},d=e.jsx("span",{style:{display:"inline-block",width:48,height:48,background:"orange",borderRadius:12,boxShadow:"0 2px 8px rgba(0,0,0,0.08)",alignItems:"center",justifyContent:"center",color:"#000",fontWeight:"bold",fontSize:16}}),c={args:{badgeType:"brand",size:"m",appearance:"text",count:1,children:d}},p={args:{badgeType:"brand",size:"m",appearance:"icon",icon:"notification",children:d}},l={args:{icon:"notification",count:1,children:d},render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",fontFamily:"Nunito Sans, sans-serif"},children:[e.jsx("h4",{children:"Appearance: Text"}),e.jsxs("div",{style:{display:"flex",gap:"16px"},children:[e.jsx(n,{...a,size:"xs"}),e.jsx(n,{...a,size:"s","data-testid":"badge-text-s"}),e.jsx(n,{...a,size:"m","data-testid":"badge-text-m"}),e.jsx(n,{...a,size:"l"})]}),e.jsx("h4",{children:"Appearance: Icon"}),e.jsxs("div",{style:{display:"flex",gap:"16px"},children:[e.jsx(n,{...a,size:"xs",appearance:"icon"}),e.jsx(n,{...a,size:"s",appearance:"icon","data-testid":"badge-icon-s"}),e.jsx(n,{...a,size:"m",appearance:"icon","data-testid":"badge-icon-m"}),e.jsx(n,{...a,size:"l",appearance:"icon"})]}),e.jsx("h4",{children:"Appearance: Empty"}),e.jsxs("div",{style:{display:"flex",gap:"16px"},children:[e.jsx(n,{...a,size:"xs",appearance:"empty"}),e.jsx(n,{...a,size:"s",appearance:"empty","data-testid":"badge-empty-s"}),e.jsx(n,{...a,size:"m",appearance:"empty"}),e.jsx(n,{...a,size:"l",appearance:"empty"})]})]}),play:async({canvasElement:a})=>{const t=h(a),s=t.getByTestId("badge-text-s").querySelector("[data-testid='badge']");i(s).not.toBeVisible();const r=t.getByTestId("badge-icon-s").querySelector("[data-testid='badge']");i(r).not.toBeVisible();const P=t.getByTestId("badge-empty-s").querySelector("[data-testid='badge']");i(P).toBeVisible();const Q=t.getByTestId("badge-text-m").querySelector("[data-testid='badge']");i(Q).toBeVisible();const U=t.getByTestId("badge-icon-m").querySelector("[data-testid='badge']");i(U).toBeVisible()}},g={args:{appearance:"empty",count:1,children:d},argTypes:{size:{control:"select",options:["xs","s","m","l"]}},render:a=>e.jsxs("div",{style:{display:"flex",gap:"16px",alignItems:"center"},children:[e.jsx(n,{...a,size:"xs"}),e.jsx(n,{...a,size:"s"}),e.jsx(n,{...a,size:"m"}),e.jsx(n,{...a,size:"l"})]})},m={args:{badgeType:"indicator",appearance:"text",size:"m",children:d},render:a=>e.jsxs("div",{style:{display:"flex",gap:"16px",alignItems:"center"},children:[e.jsx(n,{...a,count:5}),e.jsx(n,{...a,count:99}),e.jsx(n,{...a,count:100})]})},x={args:{badgeType:"brand",appearance:"icon",size:"m",icon:"notification",children:d},render:a=>e.jsxs("div",{style:{display:"flex",gap:"16px",alignItems:"center"},children:[e.jsx(n,{...a,icon:"notification"}),e.jsx(n,{...a,icon:"home"}),e.jsx(n,{...a,icon:"user"}),e.jsx(n,{...a,icon:"search"}),e.jsx(n,{...a,icon:"heart"}),e.jsx(n,{...a,icon:"star"})]})},ae=a=>{const[t,s]=X.useState(1);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:8},children:[e.jsx("div",{children:e.jsx(n,{...a,count:t})}),e.jsx("hr",{}),e.jsx("label",{children:"Badge Count"}),e.jsx("input",{id:"badge-count-input",type:"number",value:t,onChange:r=>s(Number(r.target.value)),"data-testid":"badge-count-input"})]})},y={args:{badgeType:"brand",appearance:"text",size:"m",count:1,children:d},render:ae,play:async({canvasElement:a})=>{const t=h(a),s=t.getByTestId("badge-count-input"),r=t.getByTestId("badge");i(r).toBeVisible(),await o.clear(s),await o.type(s,"0"),await B(()=>i(r).not.toBeVisible()),await o.clear(s),await o.type(s,"1"),await B(()=>i(r).toBeVisible())}},b={args:c.args,play:async({canvasElement:a})=>{const s=h(a).getByTestId("badge");await o.tab(),i(s).not.toHaveFocus()}},u={args:c.args,render:a=>e.jsxs("div",{style:{display:"flex",gap:"24px",alignItems:"center",fontFamily:"Nunito Sans, sans-serif"},children:[e.jsxs("div",{children:[e.jsx("h4",{children:"Brand"}),e.jsx(n,{...a,badgeType:"brand"})]}),e.jsxs("div",{children:[e.jsx("h4",{children:"Neutral"}),e.jsx(n,{...a,badgeType:"neutral"})]}),e.jsxs("div",{children:[e.jsx("h4",{children:"Indicator"}),e.jsx(n,{...a,badgeType:"indicator"})]})]})};var v,j,f;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    badgeType: "brand",
    size: "m",
    appearance: "text",
...
}`,...(f=(j=c.parameters)==null?void 0:j.docs)==null?void 0:f.source}}};var I,T,z;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    badgeType: "brand",
    size: "m",
    appearance: "icon",
...
}`,...(J=(G=u.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};const le=["Default","IconBadge","BadgeDisplay","Sizes","CountLimit","Icons","BadgeVisibility","KeyboardInteraction","BadgeType"];export{l as BadgeDisplay,u as BadgeType,y as BadgeVisibility,m as CountLimit,c as Default,p as IconBadge,x as Icons,b as KeyboardInteraction,g as Sizes,le as __namedExportsOrder,pe as default};
