import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{f as ue,w as T,u as p,e as d}from"./index-DaW6VCyr.js";import{r as C}from"./index-G8LIXM5I.js";import{I as A}from"./Icon-DiFFcmJA.js";import{L as xe}from"./Link-CilvQ5ec.js";import{c as pe}from"./index-DSdvzt-y.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";const O=16,H={required:"(obligatoire)",requiredIcon:"*",optional:"(facultatif)"},me="_container_dtrdk_3",he="_textarea_dtrdk_43",ve="_label_dtrdk_129",t={container:me,"top-position-container":"_top-position-container_dtrdk_8","header-container":"_header-container_dtrdk_29","textarea-container":"_textarea-container_dtrdk_43",textarea:he,"assistive-text-link":"_assistive-text-link_dtrdk_95","assistive-text":"_assistive-text_dtrdk_95","character-counter":"_character-counter_dtrdk_118",label:ve,"requirement-indicator":"_requirement-indicator_dtrdk_150"},c=C.forwardRef(({className:a="",id:o,name:r,required:n=!1,onChange:R,onBlur:N,label:m,labelId:j,labelPosition:i="top",assistiveTextLabel:k,assistiveTextAppearance:u="description",["aria-labelledby"]:te,assistiveTextLink:re,showLabelRequirement:x=!1,resizeable:ne="true",maxLength:h,defaultValue:v,showCounter:se,value:g,...L},y)=>{const[oe,ie]=C.useState((g==null?void 0:g.length)||(v==null?void 0:v.length)||0),I=C.useRef(null),le=se&&typeof h=="number",ce=l=>{var F;N&&N(l),(F=I.current)==null||F.scrollTo({top:0})},de=l=>{R&&R(l),h&&ie(l.target.value.length)},B=n?x?H.required:H.requiredIcon:H.optional;return e.jsxs("div",{className:t.container,"data-label-position":i,children:[m&&i==="side"&&e.jsxs("label",{id:j,className:t.label,htmlFor:o,"data-label-position":i,children:[m,(x||n)&&e.jsx("span",{className:t["requirement-indicator"],"data-required":n,"data-show-label-requirement":x,"aria-hidden":"true",children:B})]}),e.jsxs("div",{className:t["top-position-container"],"data-label-position":i,children:[e.jsxs("div",{className:t["header-container"],"data-label-position":i,children:[m&&i==="top"&&e.jsxs("label",{id:j,className:t.label,htmlFor:o,"data-label-position":i,children:[m,(x||n)&&e.jsx("span",{className:t["requirement-indicator"],"data-required":n,"data-show-label-requirement":x,"aria-hidden":"true",children:B})]}),le&&e.jsxs("span",{className:t["character-counter"],children:[oe,"/",h]})]}),e.jsxs("div",{className:t["textarea-container"],"data-label-position":i,children:[e.jsx("textarea",{ref:l=>{I.current=l,typeof y=="function"?y(l):y&&(y.current=l)},id:o,name:r,className:pe(t.textarea,a),"data-resizeable":ne,"data-assistive-text-appearance":u,onChange:de,"aria-labelledby":j||te,maxLength:h,onBlur:ce,defaultValue:v,value:g,...L}),k&&e.jsx(e.Fragment,{children:u==="link"?e.jsx(xe,{label:k,href:re,externalLink:!0,className:t["assistive-text-link"]}):e.jsxs("div",{className:t["assistive-text"],"data-assistive-text-appearance":u,"data-disabled":L.disabled,children:[u==="error"?e.jsx(A,{name:"error",size:O}):u==="success"?e.jsx(A,{name:"check-circle",size:O}):null,e.jsx("span",{children:k})]})})]})]})]})});c.__docgenInfo={description:"",methods:[],displayName:"Textarea",props:{onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: ChangeEvent<HTMLTextAreaElement>) => void",signature:{arguments:[{type:{name:"ChangeEvent",elements:[{name:"HTMLTextAreaElement"}],raw:"ChangeEvent<HTMLTextAreaElement>"},name:"event"}],return:{name:"void"}}},description:""},className:{defaultValue:{value:'""',computed:!1},required:!1},required:{defaultValue:{value:"false",computed:!1},required:!1},labelPosition:{defaultValue:{value:'"top"',computed:!1},required:!1},assistiveTextAppearance:{defaultValue:{value:'"description"',computed:!1},required:!1},showLabelRequirement:{defaultValue:{value:"false",computed:!1},required:!1},resizeable:{defaultValue:{value:'"true"',computed:!1},required:!1}},composes:["CoreTextareaProps","Omit"]};const je={title:"Textarea",tags:["autodocs"],component:c,args:{disabled:!1},argTypes:{value:{control:"text"},label:{control:"text"},labelPosition:{control:"select",options:["top","side"],description:"Position of the label relative to the textarea"},disabled:{control:"boolean"},rows:{control:"number"},onChange:{action:"changed"},assistiveTextAppearance:{control:"select",options:["description","error","success","link"],description:"Appearance of the assistive text"},assistiveTextLink:{control:"text",description:"Link for the assistive text when appearance is 'link'"},required:{control:"boolean",description:"Whether the textarea is required"},showLabelRequirement:{control:"boolean",description:"Whether to show the requirement indicator in the label"},maxLength:{control:"number",description:"Maximum number of characters allowed in the textarea"},showCounter:{control:"boolean",description:"Whether to display the character count"},readOnly:{control:"boolean",description:"Whether the textarea is read-only"}}},q=ue(),s={args:{id:"my-textarea",label:"Label",labelId:"LabelId",assistiveTextLabel:"Assistive text for the textarea",required:!1,showLabelRequirement:!1,onChange:q,readOnly:!1,rows:3},render:a=>e.jsx("div",{style:{width:"350px"},children:e.jsx(c,{...a})})},f={args:{...s.args,maxLength:10},render:a=>e.jsx("div",{style:{width:"350px"},children:e.jsx(c,{...a})}),play:async({canvasElement:a})=>{const r=T(a).getByRole("textbox");await p.type(r,"Hello World"),d(q).toHaveBeenCalledTimes(10),d(r).toHaveValue("Hello Worl")}},b={args:{...s.args,maxLength:100,assistiveTextLabel:"Error message",assistiveTextAppearance:"error"},render:a=>e.jsx("div",{style:{width:"350px"},children:e.jsx(c,{...a})})},w={args:{...s.args,readOnly:!0,value:"This is a read-only textarea."},render:a=>e.jsx("div",{style:{width:"350px"},children:e.jsx(c,{...a})}),play:async({canvasElement:a,args:o})=>{const n=T(a).getByRole("textbox");await p.tab(),d(n).toHaveFocus(),await p.type(n,"Hello World"),d(q).not.toHaveBeenCalled(),d(n).toHaveValue(o.value)}},_={args:{...s.args,disabled:!0},render:a=>e.jsx("div",{style:{width:"350px"},children:e.jsx(c,{...a})}),play:async({canvasElement:a})=>{const r=T(a).getByRole("textbox");await p.tab(),d(r).not.toHaveFocus()}},E={args:{...s.args},render:a=>e.jsx("div",{style:{width:"350px"},children:e.jsx(c,{...a})}),play:async({canvasElement:a})=>{const r=T(a).getByRole("textbox");await p.tab(),d(r).toHaveFocus(),r.blur()}};var D,W,S;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    id: "my-textarea",
    label: "Label",
    labelId: "LabelId",
...
}`,...(ae=(ee=E.parameters)==null?void 0:ee.docs)==null?void 0:ae.source}}};const ke=["Default","CharacterCount","Error","ReadOnly","Disabled","KeyboardInteraction"];export{f as CharacterCount,s as Default,_ as Disabled,b as Error,E as KeyboardInteraction,w as ReadOnly,ke as __namedExportsOrder,je as default};
