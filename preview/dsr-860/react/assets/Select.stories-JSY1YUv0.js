import{j as n}from"./jsx-runtime-Cf8x2fCZ.js";import{T as C,b as E}from"./keyboard-test.constants-By8W48aj.js";import{w as A,u as r,e as v}from"./index-4rjIhT2C.js";import{r as u}from"./index-G8LIXM5I.js";import{f as te}from"./testing.utils-BiEcdOD7.js";import{S as p}from"./Select-CnFGetEy.js";import"./index-yBjzXJbu.js";import"./keyboard.constants-BverKK8B.js";import"./_commonjsHelpers-CqkleIqs.js";import"./timepicker.constants-CynrC_9x.js";import"./icon.constants-CvX5SV3k.js";import"./Label-Bgp-fFvQ.js";import"./Icon-DgLH6pPJ.js";import"./Link-B53ZmOEu.js";import"./NavigationContext-D2CUoNWC.js";import"./index-DJ8f9STe.js";import"./Badge-DkJhvK8e.js";import"./Chip-B_jXPpNa.js";import"./useActiveKeyboard-DaOmFJe_.js";import"./Dropdown-Csevbhnq.js";import"./useGetOverlayLayerLevel-58-DKw2q.js";import"./dom.constants-Bk0jVzGk.js";import"./useAnimatedMount-_zPBpYOt.js";import"./useScrollEvent-BvD0VCKE.js";import"./Divider-BMotkXeQ.js";import"./Overlay-BdeF33Ax.js";import"./index-DML4njjH.js";import"./index-BLHw34Di.js";import"./DropdownItem-CDrtBJ9h.js";import"./Checkbox-C8hWUkyN.js";import"./IconButton-D7Ub3mhB.js";import"./common-button.constants-CJxonyEE.js";import"./IconButton.module-DsipBz7u.js";const Re={title:"Composants/Select/Select",component:p,tags:["autodocs"],argTypes:{id:{control:"text"},label:{control:"text"},labelPosition:{control:{type:"select"},options:["top","side"]},showLabel:{control:"boolean"},isError:{control:"boolean"},assistiveAppearance:{control:{type:"select"},options:["description","error","success","link"]},showAssistiveIcon:{control:"boolean"},assistiveTextLabel:{control:"text"},showLabelRequirement:{control:"boolean"},required:{control:"boolean"},options:{control:"object"},disabled:{control:"boolean"},readonly:{control:"boolean"},showResetButton:{control:"boolean"},multiple:{control:"boolean"},withSelectAll:{control:"boolean"},optionToDisplay:{control:{type:"select"},options:["first-selected","last-selected","highest-selected"]},compactSpacing:{control:"boolean"},placeholder:{control:"text"},variant:{control:{type:"select"},options:["default","visibly-selected"]},maxHeight:{control:{type:"number"}}}},c={args:{id:"select1",label:"Choisir une option",showLabel:!0,isError:!1,assistiveAppearance:"description",showAssistiveIcon:!1,assistiveTextLabel:"This is a description for the select component.",options:[{value:"option-1",label:"Option 1"},{value:"option-2",label:"Option 2"},{value:"option-3",label:"Option 3"},{value:"option-4",label:"Option 4"},{value:"option-5",label:"Option 5"},{value:"option-6",label:"Option 6"},{value:"option-7",label:"Option 7"},{value:"option-8",label:"Option 8"},{value:"option-9",label:"Option 9"},{value:"option-10",label:"Option 10"},{value:"option-11",label:"Option 11"},{value:"option-12",label:"Option 12"},{value:"option-13",label:"Option 13"},{value:"option-14",label:"Option 14"},{value:"option-15",label:"Option 15"},{value:"option-16",label:"Option 16"},{value:"option-17",label:"Option 17"},{value:"option-18",label:"Option 18"},{value:"option-19",label:"Option 19"},{value:"option-20",label:"Option 20"}],disabled:!1,readonly:!1,showResetButton:!1,withSelectAll:!1,optionToDisplay:"first-selected",compactSpacing:!1,placeholder:"Select an option",required:!1},render:a=>{const[e,o]=u.useState({label:"Option 2",value:"option-2"}),l=t=>{var s;o((s=a.options)==null?void 0:s.find(i=>i.value===t))};return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,onChange:l,value:(e==null?void 0:e.value)??"",multiple:!1}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected value : ",(e==null?void 0:e.label)||"No value"]})]})}},g={args:{...c.args,isError:!0},render:a=>{const[e,o]=u.useState(),l=t=>{var s;typeof t=="string"&&o((s=a.options)==null?void 0:s.find(i=>i.value===t))};return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,onChange:l,value:(e==null?void 0:e.value)??"",multiple:!1}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected value : ",(e==null?void 0:e.label)||"No value"]})]})}},m={args:{...c.args,readonly:!0},render:a=>{const[e,o]=u.useState(),l=t=>{var s;typeof t=="string"&&o((s=a.options)==null?void 0:s.find(i=>i.value===t))};return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,onChange:l,value:(e==null?void 0:e.value)??"",multiple:!1}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected value : ",(e==null?void 0:e.label)||"No value"]})]})},play:async({canvasElement:a})=>{const o=A(a).getAllByRole("combobox")[1];await r.tab(),v(o).not.toHaveFocus()}},y={args:{...c.args,disabled:!0},render:a=>{const[e,o]=u.useState(),l=t=>{var i;const s=Array.isArray(t)?t[0]:t;o((i=a.options)==null?void 0:i.find(d=>d.value===s))};return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,onChange:l,value:(e==null?void 0:e.value)??"",multiple:!1}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected value : ",(e==null?void 0:e.label)||"No value"]})]})},play:async({canvasElement:a})=>{const o=A(a).getAllByRole("combobox")[1];await r.tab(),v(o).not.toHaveFocus()}},b={args:{...c.args,compactSpacing:!0},render:a=>{const[e,o]=u.useState(),l=t=>{var i;const s=Array.isArray(t)?t[0]:t;o((i=a.options)==null?void 0:i.find(d=>d.value===s))};return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,onChange:l,value:(e==null?void 0:e.value)??"",multiple:!1}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected value : ",(e==null?void 0:e.label)||"No value"]})]})}},f={args:{...c.args,variant:"visibly-selected"},render:a=>{const[e,o]=u.useState(),l=t=>{var i;const s=Array.isArray(t)?t[0]:t;o((i=a.options)==null?void 0:i.find(d=>d.value===s))};return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,onChange:l,value:(e==null?void 0:e.value)??"",multiple:!1}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected value : ",(e==null?void 0:e.label)||"No value"]})]})}},h={args:{...c.args,withSelectAll:!0},render:a=>{const[e,o]=u.useState(["option-2","option-1"]),l=t=>{o(t)};return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,onChange:l,value:e,multiple:!0}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected values :"," ",e.length>0?e.map(t=>t).join(", "):"No value"]})]})}},O={args:{...c.args},render:a=>{const[e,o]=u.useState(),l=[{value:"option-1",label:"Option 1"},{value:"option-2",label:"Option 2"},{value:"option-3",label:"Option 3"},{value:"option-4",label:"Option 4"}],t=i=>{o(l.find(d=>d.value===i))},s=()=>n.jsxs(n.Fragment,{children:[n.jsx("div",{style:{padding:"16px",fontFamily:"Arial",color:"var(--content-primary)"},children:"This is a custom body for the select component."}),n.jsx("button",{onClick:()=>t(l[0].value),children:"Select Option 1"}),n.jsx("button",{onClick:()=>t(l[1].value),children:"Select Option 2"}),n.jsx("button",{onClick:()=>t(l[2].value),children:"Select Option 3"}),n.jsx("button",{onClick:()=>t(l[3].value),children:"Select Option 4"})]});return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,body:n.jsx(s,{})}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected value : ",(e==null?void 0:e.label)||"No value"]})]})}},x={args:{...c.args,showResetButton:!0},render:a=>{const[e,o]=u.useState(),l=t=>{var i;const s=Array.isArray(t)?t[0]:t;o((i=a.options)==null?void 0:i.find(d=>d.value===s))};return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...a,onChange:l,value:(e==null?void 0:e.value)??"",multiple:!1}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Selected value : ",(e==null?void 0:e.label)||"No value"]})]})},play:async({canvasElement:a,args:e})=>{const l=A(a).getAllByRole("combobox")[1];te(),await r.tab(),v(l).toHaveFocus(),await r.keyboard(C),await r.tab(),await r.keyboard(E),await r.keyboard(C),v(l).toHaveTextContent("Option 2");const t=l.querySelector("button"),s=l.querySelector("[data-testid='trigger-icon']");await r.click(t),v(l).toHaveTextContent(e.placeholder),await r.click(s),await r.tab(),await r.tab(),await r.keyboard(E),await r.keyboard(E),await r.keyboard(C),v(l).toHaveTextContent("Option 3")}},S={args:{...c.args},render:a=>{const[e,o]=u.useState(null),{value:l,...t}=a;return n.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[n.jsx(p,{...t,defaultValue:"option-3",onChange:s=>o(s),multiple:!1}),n.jsxs("span",{style:{fontFamily:"Arial",color:"var(--content-primary)"},children:["Last emitted value : ",e||"None yet"]})]})}};var w,j,D;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    id: "select1",
