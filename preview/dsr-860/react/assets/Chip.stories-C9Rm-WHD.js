import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{T as h,a as V}from"./keyboard-test.constants-By8W48aj.js";import{E as K}from"./keyboard.constants-BverKK8B.js";import{w as C,u as l,e as c,f as M}from"./index-4rjIhT2C.js";import{r as f}from"./index-G8LIXM5I.js";import{B as O}from"./Button-KJfdYR4G.js";import{T as D}from"./TextInput-021w0b3O.js";import{C as v}from"./Chip-B_jXPpNa.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./common-button.constants-CJxonyEE.js";import"./Badge-DkJhvK8e.js";import"./Icon-DgLH6pPJ.js";import"./index-DJ8f9STe.js";import"./BaseTextInput-wSuYcq-n.js";import"./Label-Bgp-fFvQ.js";import"./Link-B53ZmOEu.js";import"./NavigationContext-D2CUoNWC.js";import"./IconButton-D7Ub3mhB.js";import"./IconButton.module-DsipBz7u.js";import"./useActiveKeyboard-DaOmFJe_.js";const oe={title:"Composants/Chip/Chip",component:v,tags:["autodocs"],argTypes:{label:{control:"text",description:"Label of the chip",defaultValue:"Chip"},disabled:{control:"boolean"},compactSpacing:{control:"boolean",description:"Whether the chip should be compact"},type:{control:"select",options:["single","multi","input"],description:"Type of the chip",defaultValue:"single"},appearance:{control:"select",options:["brand","neutral"],description:"Appearance of the chip",defaultValue:"brand"}},args:{onClick:M()}},y={args:{id:"chip-1",label:"Label",selected:!1,disabled:!1,compactSpacing:!1}},g={args:{...y.args},render:s=>{var n;const[a,t]=f.useState(null),o=[{id:"all",label:"All"},{id:"option-1",label:"Option 1"},{id:"option-2",label:"Option 2"}],d=i=>{const r=i.currentTarget.id;t(r===a?null:r)};return e.jsxs(e.Fragment,{children:[e.jsxs("p",{style:{fontFamily:"Arial, sans-serif",marginTop:"20px",color:"var(--content-primary)"},children:["Chip sélectionnée: ",((n=o.find(i=>i.id===a))==null?void 0:n.label)||"Aucune"]}),e.jsxs("div",{style:{display:"flex",gap:"30px",flexDirection:"column"},children:[e.jsxs("div",{children:[e.jsx("p",{style:{fontFamily:"arial",color:"var(--content-primary)"},children:"Appearance: brand"}),e.jsx("div",{style:{display:"flex",gap:"10px"},role:"radiogroup","data-testid":"test-chip-group",children:o.map(({id:i,label:r})=>e.jsx(v,{id:i,label:r,selected:a===i,onClick:d,type:"single",compactSpacing:s.compactSpacing,className:"chip",disabled:s.disabled},i))})]}),e.jsxs("div",{children:[e.jsx("p",{style:{fontFamily:"arial",color:"var(--content-primary)"},children:"Appearance: neutral"}),e.jsx("div",{style:{display:"flex",gap:"10px"},role:"radiogroup","data-testid":"test-chip-group-neutral",children:o.map(({id:i,label:r})=>e.jsx(v,{id:i,label:r,selected:a===i,onClick:d,type:"single",compactSpacing:s.compactSpacing,className:"chip",appearance:"neutral",disabled:s.disabled},i))})]})]})]})},play:async({canvasElement:s})=>{const t=C(s).getByTestId("test-chip-group").querySelectorAll("[role='radio']");await l.click(t[0]),c(t[0]).toHaveAttribute("aria-checked","true"),await l.click(t[1]),c(t[1]).toHaveAttribute("aria-checked","true"),c(t[0]).toHaveAttribute("aria-checked","false"),await l.click(t[1]),await l.tab(),c(t[2]).toHaveFocus(),await l.keyboard(h),c(t[2]).toHaveAttribute("aria-checked","true"),await l.keyboard(V),c(t[2]).toHaveAttribute("aria-checked","false")}},b={args:{...y.args},render:s=>{const[a,t]=f.useState([]),o=[{id:"option-1",label:"Option 1"},{id:"option-2",label:"Option 2"},{id:"option-3",label:"Option 3"}],d=n=>{const i=n.currentTarget.id;t(r=>r.includes(i)?r.filter(m=>m!==i):[...r,i])};return e.jsxs(e.Fragment,{children:[e.jsxs("p",{style:{fontFamily:"Arial, sans-serif",marginTop:"20px",color:"var(--content-primary)"},children:["Chip(s) sélectionnée(s):"," ",o.filter(n=>a.includes(n.id)).map(n=>n.label).join(", ")]}),e.jsxs("div",{style:{display:"flex",gap:"30px",flexDirection:"column"},children:[e.jsxs("div",{children:[e.jsx("p",{style:{fontFamily:"arial",color:"var(--content-primary)"},children:"Appearance: brand"}),e.jsx("div",{style:{display:"flex",gap:"10px"},role:"group",children:o.map(({id:n,label:i})=>e.jsx(v,{id:n,label:i,selected:a.includes(n),onClick:d,type:"multi",compactSpacing:s.compactSpacing,disabled:s.disabled},n))})]}),e.jsxs("div",{children:[e.jsx("p",{style:{fontFamily:"arial",color:"var(--content-primary)"},children:"Appearance: neutral"}),e.jsx("div",{style:{display:"flex",gap:"10px"},role:"group",children:o.map(({id:n,label:i})=>e.jsx(v,{id:n,label:i,selected:a.includes(n),onClick:d,type:"multi",compactSpacing:s.compactSpacing,appearance:"neutral",disabled:s.disabled},n))})]})]})]})},play:async({canvasElement:s})=>{const t=C(s).getAllByRole("checkbox");await l.click(t[0]),c(t[0]).toHaveAttribute("aria-checked","true"),await l.click(t[1]),c(t[1]).toHaveAttribute("aria-checked","true"),c(t[0]).toHaveAttribute("aria-checked","true"),await l.click(t[1]),c(t[1]).toHaveAttribute("aria-checked","false"),await l.tab(),c(t[2]).toHaveFocus(),await l.keyboard(h),c(t[2]).toHaveAttribute("aria-checked","true")}},x={args:{...y.args,type:"input"},render:s=>{const[a,t]=f.useState(""),[o,d]=f.useState([]),n=p=>{t(p)},i=p=>{p.key===K&&(p.preventDefault(),r())},r=()=>{a&&!o.includes(a)&&(d(p=>[...p,a]),t(""))},m=p=>{const u=p.currentTarget.value;d(E=>E.includes(u)?E.filter(_=>_!==u):E)};return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[e.jsxs("div",{style:{display:"flex",gap:"10px",alignItems:"end"},children:[e.jsx(D,{id:"input-add-chip",label:"Ajouter un chip",value:a,onChange:n,onKeyDown:i}),e.jsx(O,{label:"Ajouter",onClick:r})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:[o.length>0&&e.jsx("div",{style:{display:"flex",gap:"10px"},role:"listbox","aria-label":"Chips list","data-testid":"chips-list",children:o.map((p,u)=>e.jsx(v,{id:`chip-${u}-${p}`,label:p,selected:!1,disabled:s.disabled,type:"input",onClose:m},u+p))}),o.length>0&&e.jsx("div",{style:{display:"flex",gap:"10px"},role:"listbox","aria-label":"Chips list",children:o.map((p,u)=>e.jsx(v,{id:`chip-${u}-${p}`,label:p,selected:!1,disabled:s.disabled,type:"input",onClose:m,appearance:"neutral"},u+p))})]})]})},play:async({canvasElement:s})=>{const a=C(s),t=a.getByRole("textbox");await l.type(t,"New Chip"),await l.keyboard(h),await l.type(t,"Another Chip"),await l.keyboard(h);const o=a.getByTestId("chips-list").querySelectorAll("[role='option']");c(o).toHaveLength(2);const d=C(o[0]).getByRole("button");await l.click(d);const n=a.getByTestId("chips-list").querySelectorAll("[role='option']");c(n).toHaveLength(1),await l.type(t,"More Chip"),await l.keyboard(h);const i=a.getByTestId("chips-list").querySelectorAll("[role='option']");c(i).toHaveLength(2),i[0].focus(),await l.tab(),await l.keyboard(h),c(a.getByTestId("chips-list").querySelectorAll("[role='option']")).toHaveLength(1),await l.type(t,"Last Chip"),await l.keyboard(h),c(a.getByTestId("chips-list").querySelectorAll("[role='option']")).toHaveLength(2),a.getByTestId("chips-list").querySelectorAll("[role='option']")[1].focus(),await l.tab(),await l.keyboard(V),c(a.getByTestId("chips-list").querySelectorAll("[role='option']")).toHaveLength(1)}};var k,T,S;y.parameters={...y.parameters,docs:{...(k=y.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    id: "chip-1",
    label: "Label",
    selected: false,
...
}`,...(S=(T=y.parameters)==null?void 0:T.docs)==null?void 0:S.source}}};var A,w,H;g.parameters={...g.parameters,docs:{...(A=g.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  render: args => {
...
}`,...(H=(w=g.parameters)==null?void 0:w.docs)==null?void 0:H.source}}};var I,L,j;b.parameters={...b.parameters,docs:{...(I=b.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    ...Default.args
  },
  render: args => {
...
}`,...(B=(N=x.parameters)==null?void 0:N.docs)==null?void 0:B.source}}};const pe=["Default","SingleSelect","MultiSelect","Input"];export{y as Default,x as Input,b as MultiSelect,g as SingleSelect,pe as __namedExportsOrder,oe as default};
