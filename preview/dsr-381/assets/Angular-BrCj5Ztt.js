import{j as e,M as i}from"./index-BNmsNRAE.js";import{useMDXComponents as r}from"./index-DL7Mpk60.js";/* empty css                   *//* empty css               */import"./iframe-BZBL0SMc.js";import"./index-B0WjJBI_.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-Dif16jpf.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";function t(s){const n={code:"code",pre:"pre",strong:"strong",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Design system/Get Started - Kit de démarrage/Angular"}),`
...
`,e.jsxs("ul",{children:[e.jsxs("li",{children:[" ",e.jsx("a",{href:"https://opensource.rte-france.com/design-system-rte/?path=/docs/angular_button--docs",children:"Documentation des composants Angular"})," : Explorez tous les composants disponibles dans le Storybook "]}),e.jsxs("li",{children:[" ",e.jsx("a",{href:"https://opensource.rte-france.com/design-system-rte/?path=/docs/design-system-get-started-kit-de-migration-angular--docs",children:"Guide de migration"})," : Si vous migrez depuis RGO-lib ou si vous utilises Angular Material déjà dans votre projet "]})]}),`
...
`,e.jsxs("p",{children:[" Pour lire les changelogs de tous les packages, consultez le ",e.jsx("a",{href:"https://github.com/rte-france/design-system-rte/blob/main/CHANGELOG.md",children:"CHANGELOG principal"}),". "]})]})}function g(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{g as default};
