import{j as t}from"./jsx-runtime-Cf8x2fCZ.js";import{S as w,E as j}from"./keyboard.constants-BverKK8B.js";import{w as R,u as n,e as s}from"./index-4rjIhT2C.js";import{r as V}from"./index-G8LIXM5I.js";import{f as D}from"./testing.utils-mIZIUNbM.js";import{S as i}from"./Switch-CtZryQy5.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./Icon-DgLH6pPJ.js";import"./index-DJ8f9STe.js";const P={title:"Composants/Switch/Switch",component:i,decorators:[e=>t.jsxs("div",{style:{height:"50px",width:"200px"},children:[t.jsx(e,{}),t.jsxs("div",{children:[" ",t.jsxs("p",{children:[" ","Switch State : ",t.jsx("span",{id:"switch-state",children:" "})]})]})]})],tags:["autodocs"],argTypes:{label:{control:"text",description:"Label for the switch",defaultValue:"Label"},appearance:{control:"select",options:["brand","neutral"],description:"Appearance of the switch",defaultValue:"brand"},showLabel:{control:"boolean",description:"Whether to show the label",defaultValue:!0},showIcon:{control:"boolean",description:"Whether to show the icon",defaultValue:!0},disabled:{control:"boolean",description:"Whether the switch is disabled",defaultValue:!1},readOnly:{control:"boolean",description:"Whether the switch is read-only",defaultValue:!1},checked:{control:"boolean",description:"Checked state (controlled)",defaultValue:!1},defaultChecked:{control:"boolean",description:"Default checked state (uncontrolled)",defaultValue:!1},onChange:{action:"changed",description:"Function called when the switch state changes"}}},o={args:{label:"Label",showLabel:!0,disabled:!1,readOnly:!1,appearance:"brand",showIcon:!0,checked:!1},render:e=>{const[h,a]=V.useState(!!e.checked);return t.jsx(i,{...e,checked:h,onChange:d=>{var p;a(d.target.checked);const B=d.target.checked?"ON":"OFF",u=document.getElementById("switch-state");u&&(u.textContent=B),(p=e.onChange)==null||p.call(e,d)}})},play:async({canvasElement:e})=>{const a=R(e).getByRole("switch");D(e),await n.tab(),await s(a).toHaveFocus(),await n.keyboard(w),await s(a).toBeChecked(),await n.keyboard(w),await s(a).not.toBeChecked(),await n.keyboard(j),await s(a).not.toBeChecked()}},c={args:{label:"Uncontrolled Switch",defaultChecked:!0},render:e=>t.jsx(i,{...e})},r={args:{label:"Disabled Switch",disabled:!0}},l={args:{label:"Read-Only Switch",readOnly:!0}};var m,b,f;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    label: "Label",
    showLabel: true,
    disabled: false,
