...
declare const DropdownItem: ({ label, link, leftIcon, trailingText, disabled, hasSeparator, hasIndent, children, badgeCount, badgeContent, badgeIcon, badgeType, badgeSize, showBadge, isSelected, isIndeterminate, onClick, hasCheckbox, ...props }: DropdownItemProps) => import("react").JSX.Element;
