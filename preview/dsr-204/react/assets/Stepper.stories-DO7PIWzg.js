import{j as t}from"./jsx-runtime-Cf8x2fCZ.js";import{f as _,e as re}from"./keyboard-test.constants-By8W48aj.js";import{w as pe,u as h,a as oe,e as g}from"./index-BfPN6pki.js";import{r as u}from"./index-G8LIXM5I.js";import{f as le}from"./testing.utils-CYMf4Aux.js";import{B as C}from"./Button-CoCTt7OM.js";import{I as ce}from"./IconButton-Cd1eiha_.js";import{F as se}from"./dom.constants-pEgPeCLJ.js";import{T as de,a as A,A as N,d as R,b as T}from"./keyboard.constants-BverKK8B.js";import{I as me}from"./Badge-CQk6fGHb.js";import{I as ue}from"./Icon-DjEid3Hw.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-CqkleIqs.js";import"./common-button.constants-eNlmcvUj.js";import"./index-DSdvzt-y.js";const z=(e,s)=>{var i;let n=e===s.length-1?0:e+1;for(;((i=s[n])==null?void 0:i.getAttribute("aria-disabled"))==="true";)n===s.length-1?n=0:n++;s[n].focus()},F=(e,s)=>{var i;let n=e===0?s.length-1:e-1;for(;((i=s[n])==null?void 0:i.getAttribute("aria-disabled"))==="true";)n===0?n=s.length-1:n--;s[n].focus()},ve=(e,s)=>{var a;const n=document.activeElement,i=Array.from(document.querySelectorAll(se)),r=Array.from(i).indexOf(n);let o=r===i.length-1?0:r+1;for(;(a=i[o])!=null&&a.classList.contains(e)&&(s!=null&&s.contains(i[o]));)o===i.length-1?o=0:o++;i[o].focus()},Se=(e,s)=>{var a;const n=document.activeElement,i=Array.from(document.querySelectorAll(se)),r=Array.from(i).indexOf(n);let o=r===0?i.length-1:r-1;for(;(a=i[o])!=null&&a.classList.contains(e)&&(s!=null&&s.contains(i[o]));)o===0?o=i.length-1:o--;i[o].focus()},xe=e=>{const{completionState:s,clickableCompleteStep:n}=e;return s==="complete"&&n||s==="unvisited"||s==="incomplete"},he="_stepper_1oua5_1",ge={stepper:he},ye="_stepperItem_g2ws8_1",fe="_stepButton_g2ws8_6",Ie="_stepNumber_g2ws8_13",we="_stepCompleteIndicator_g2ws8_14",be="_stepName_g2ws8_51",v={stepperItem:ye,stepButton:fe,stepNumber:Ie,stepCompleteIndicator:we,stepName:be},ie=({number:e,name:s,completionState:n="unvisited",orientation:i="horizontal",onClick:r,clickableCompleteStep:o=!1,isActive:a,...c})=>{const m=u.useRef(null),x=r&&xe({completionState:n,clickableCompleteStep:o}),p=x||a,d=()=>{x&&!a&&r&&r()};return t.jsx("li",{className:v.stepperItem,"data-completion-state":n,"data-orientation":i,ref:m,"data-clickable":x,"aria-current":a?"step":void 0,"data-active":a,...c,children:t.jsxs("button",{className:v.stepButton,type:"button",onClick:d,disabled:!p,tabIndex:a?0:-1,children:[n==="complete"&&!a?t.jsx("div",{className:v.stepCompleteIndicator,children:t.jsx(ue,{name:"check",size:me.m,"aria-hidden":"true"})}):t.jsx("div",{className:v.stepNumber,"data-completion-state":n,children:t.jsx("span",{children:e})}),t.jsx("span",{className:v.stepName,children:s})]})})};ie.__docgenInfo={description:"",methods:[],displayName:"StepperItem",props:{onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},completionState:{defaultValue:{value:'"unvisited"',computed:!1},required:!1},orientation:{defaultValue:{value:'"horizontal"',computed:!1},required:!1},clickableCompleteStep:{defaultValue:{value:"false",computed:!1},required:!1}},composes:["coreStepperItemProps","Omit"]};const je="_stepSeparator_1xofu_1",ke={stepSeparator:je},ne=({isComplete:e,orientation:s})=>t.jsx("div",{style:{width:"100%",height:"100%"},children:t.jsx("div",{className:ke.stepSeparator,role:"separator","data-complete":e,"data-orientation":s})});ne.__docgenInfo={description:"",methods:[],displayName:"StepperSeparator",props:{isComplete:{required:!0,tsType:{name:"boolean"},description:""},orientation:{required:!1,tsType:{name:"union",raw:'"horizontal" | "vertical"',elements:[{name:"literal",value:'"horizontal"'},{name:"literal",value:'"vertical"'}]},description:""}}};const l=u.forwardRef(({steps:e,orientation:s="horizontal",activeStepId:n,...i},r)=>{const[o,a]=u.useState(null),c=u.useRef(null),m=u.useCallback(p=>{c.current=p,a(p),typeof r=="function"?r(p):r&&(r.current=p)},[r]),x=p=>{if(p.key===de&&(p.preventDefault(),p.shiftKey?Se(v.stepButton,c.current):ve(v.stepButton,c.current)),[A,N,R,T].includes(p.key)){p.preventDefault(),p.stopPropagation();const d=o==null?void 0:o.querySelectorAll("button");if(d){const y=Array.from(d).findIndex(ae=>ae===document.activeElement);if(s==="horizontal")switch(p.key){case A:{F(y,Array.from(d));break}case N:{z(y,Array.from(d));break}default:return}else switch(p.key){case R:{F(y,Array.from(d));break}case T:{z(y,Array.from(d));break}default:return}}}};return e.length<2||e.length>7?(console.warn("Stepper component requires between 2 and 7 steps to function properly."),null):t.jsx("nav",{"aria-label":"Progression",style:{width:"100%",height:"100%"},ref:m,...i,children:t.jsx("ol",{className:ge.stepper,"data-orientation":s,children:e.map((p,d)=>t.jsxs(u.Fragment,{children:[t.jsx(ie,{id:p.id,number:d+1,name:p.name,completionState:p.completionState,orientation:s,onKeyDown:x,onClick:p.onClick,isActive:p.id===n,clickableCompleteStep:p.clickableCompleteStep}),d<e.length-1&&t.jsx(ne,{isComplete:p.completionState==="complete",orientation:s})]},p.name+d))})})});l.__docgenInfo={description:"",methods:[],displayName:"Stepper",props:{activeStepId:{required:!0,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:""},orientation:{defaultValue:{value:'"horizontal"',computed:!1},required:!1}},composes:["coreStepperProps"]};const Ve={title:"Composants/Stepper/Stepper",component:l,tags:["autodocs"],argTypes:{steps:{control:"object"},orientation:{control:{type:"select"},options:["horizontal","vertical"]},activeStepId:{control:"text"}}},E=[{id:"1",name:"Étape 1",completionState:"complete"},{id:"2",name:"Étape 2",completionState:"incomplete"},{id:"3",name:"Étape 3",completionState:"unvisited"},{id:"4",name:"Étape 4",completionState:"unvisited"},{id:"5",name:"Étape 5",completionState:"unvisited"},{id:"6",name:"Étape 6",completionState:"unvisited"},{id:"7",name:"Étape 7",completionState:"unvisited"}],_e=[{id:"1",name:"Étape 1",completionState:"complete",onClick:()=>console.log("Étape 1 clicked"),clickableCompleteStep:!0},{id:"2",name:"Étape 2",completionState:"incomplete",onClick:()=>console.log("Étape 2 clicked")},{id:"3",name:"Étape 3",completionState:"unvisited",onClick:()=>console.log("Étape 3 clicked")},{id:"4",name:"Étape 4",completionState:"unvisited",onClick:()=>console.log("Étape 4 clicked")},{id:"5",name:"Étape 5",completionState:"unvisited",onClick:()=>console.log("Étape 5 clicked")},{id:"6",name:"Étape 6",completionState:"unvisited",onClick:()=>console.log("Étape 6 clicked")},{id:"7",name:"Étape 7",completionState:"unvisited",onClick:()=>console.log("Étape 7 clicked")}],Ee=[{id:"1",name:"Étape 1",completionState:"unvisited"},{id:"2",name:"Étape 2",completionState:"unvisited"},{id:"3",name:"Étape 3",completionState:"unvisited"},{id:"4",name:"Étape 4",completionState:"unvisited"}],S={args:{steps:E,orientation:"horizontal",activeStepId:"3"},render:e=>t.jsx("div",{style:{width:"300px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,3),activeStepId:e.steps[1].id})})},f={args:{...S.args,orientation:"vertical"},render:e=>t.jsx("div",{style:{height:"300px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,3),activeStepId:e.steps[1].id})})},I={args:{...S.args,orientation:"horizontal"},render:e=>t.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"24px"},children:[t.jsx("div",{style:{width:"160px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,2),activeStepId:e.steps[1].id})}),t.jsx("div",{style:{width:"274px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,3)})}),t.jsx("div",{style:{width:"384px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,4)})}),t.jsx("div",{style:{width:"488px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,5)})}),t.jsx("div",{style:{width:"592px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,6)})}),t.jsx("div",{style:{width:"680px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,7)})})]})},w={args:{steps:E,orientation:"vertical",activeStepId:"3"},render:e=>t.jsxs("div",{style:{display:"flex",flexDirection:"row",gap:"8px"},children:[t.jsx("div",{style:{height:"144px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,2),activeStepId:e.steps[1].id})}),t.jsx("div",{style:{height:"240px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,3)})}),t.jsx("div",{style:{height:"336px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,4)})}),t.jsx("div",{style:{height:"424px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,5)})}),t.jsx("div",{style:{height:"512px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,6)})}),t.jsx("div",{style:{height:"584px"},children:t.jsx(l,{...e,steps:e.steps.slice(0,7)})})]})},b={args:{steps:E.slice(0,4),orientation:"horizontal",activeStepId:"3"},render:e=>{const[s,n]=u.useState(e.activeStepId),i=e.steps.map(r=>({...r,onClick:()=>n(r.id),clickableCompleteStep:!0}));return t.jsxs("div",{style:{width:"100%"},children:[t.jsx("div",{style:{width:"400px",padding:"16px"},children:t.jsx(l,{steps:i,activeStepId:s})}),t.jsx("div",{style:{marginTop:"16px",width:"100%"},children:t.jsxs("p",{children:["Contenu de l'étape ",s," ",s==="1"?"déjà validé":s==="2"?"à valider":""]})})]})}},j={args:{...S.args,steps:Ee,activeStepId:"1"},render:e=>{const[s,n]=u.useState(e.activeStepId),[i,r]=u.useState(e.steps),o=a=>{r(c=>c.map(m=>m.id===a?{...m,completionState:"complete"}:m))};return t.jsxs("div",{style:{width:"100%"},children:[t.jsx("div",{style:{width:"400px",backgroundColor:"var(--background-surface-primary)",padding:"16px"},children:t.jsx(l,{steps:i,activeStepId:s})}),t.jsx("div",{style:{marginTop:"16px",width:"100%"},children:s===null?t.jsx("p",{children:"Processus terminé !"}):t.jsxs("p",{children:["Contenu de l'étape ",s]})}),t.jsxs("div",{style:{marginTop:"16px",display:"flex",gap:"8px"},children:[t.jsx(C,{disabled:s===null,label:"Valider et passer à l'étape suivante",onClick:()=>{const a=i.findIndex(c=>c.id===s);o(s),a<i.length-1?n(i[a+1].id):n(null)}}),t.jsx(C,{disabled:s===null,label:"Valider partiellement et passer à l'étape suivante",onClick:()=>{const a=i.findIndex(c=>c.id===s);a<i.length-1&&(n(i[a+1].id),r(c=>{const m=[...c];return m[a]={...m[a],completionState:"incomplete"},m}))}}),t.jsx(ce,{variant:"text",name:"reload","aria-label":"Recommencer",onClick:()=>{n(i[0].id),r(i.map(a=>({...a,completionState:"unvisited"})))}})]})]})}},k={args:{steps:_e,orientation:"horizontal",activeStepId:"3"},render:e=>t.jsx("div",{style:{width:"700px"},children:t.jsx(l,{...e})}),play:async({canvasElement:e})=>{const n=await(await pe(e)).getByRole("list"),i=n.querySelectorAll("button"),r=n.querySelector("[aria-current='step'] button");le(e),await h.tab(),await oe(()=>{g(r).toHaveFocus()}),await h.keyboard(_),g(i[1]).toHaveFocus(),await h.keyboard(_),g(i[0]).toHaveFocus(),await h.keyboard(_),g(i[i.length-1]).toHaveFocus(),await h.keyboard(re),g(i[0]).toHaveFocus()}};var B,O,q;S.parameters={...S.parameters,docs:{...(B=S.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    steps: steps,
...
}`,...(q=(O=S.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var K,P,D;f.parameters={...f.parameters,docs:{...(K=f.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    ...Default.args,
...
}`,...(D=(P=f.parameters)==null?void 0:P.docs)==null?void 0:D.source}}};var H,L,V;I.parameters={...I.parameters,docs:{...(H=I.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    orientation: "horizontal"
  },
...
}`,...(V=(L=I.parameters)==null?void 0:L.docs)==null?void 0:V.source}}};var Y,W,G;w.parameters={...w.parameters,docs:{...(Y=w.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    steps,
    orientation: "vertical",
    activeStepId: "3"
...
}`,...(te=(ee=k.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};const Ye=["Default","Vertical","Sizes","VerticalSizes","NonLinearProgression","LinearProgression","KeyboardNavigation"];export{S as Default,k as KeyboardNavigation,j as LinearProgression,b as NonLinearProgression,I as Sizes,f as Vertical,w as VerticalSizes,Ye as __namedExportsOrder,Ve as default};
