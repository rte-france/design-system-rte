import { DateSegmentEnum, TimeFormat } from '../../../../core';
...
export declare const areSameDate: (firstDate: Date | null, secondDate: Date | null) => boolean;
export declare const areSameTime: (firstTime: TimeFormat | null, secondTime: TimeFormat | null) => boolean;
